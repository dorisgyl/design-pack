---
slug: packs/design-pack/templates/deck-pitch
type: template
lang: en
category: slides
title: "NevoFlux Investor Pitch Deck"
title_zh: "投资人 Pitch Deck"
description: "A 10-page, investor-ready fundraising deck on a white ground with a blue-to-violet gradient hero, traction bar chart, and a $X.XM ask page."
tags: [pitch, investor, seed, vc, template]
...
A 10-page, investor-ready fundraising deck. The intent is a polished narrative you can take straight into a seed round.

### Layout (one slide per beat)
- Cover - logo + tagline + round / $ask.
- Problem, Solution, Why Now.
- Product - screenshot placeholder.
- Market size - TAM / SAM / SOM.
- Traction - bar chart with large headline numbers.
- Business model.
- Go-to-market.
- Team.
- Ask - a "$4.5M-style" page.
- Thanks / contact.

### Design details
- White (`#ffffff`) base with a blue-to-violet-to-magenta gradient hero (`#3b5bff` -> `#7a46ff` -> `#d94cff`); the cover carries a soft gradient wash plus a blurred gradient blob.
- Generous slide padding (`88px 112px`), oversized display type (`.h1` 86px / 900 weight, `.h2` 62px / 800), and a giant ghosted section number per content slide.
- Metric figures and the cover/closing `.mega` use the gradient as clipped text fill; the closing slide reuses the cover wash.
- Cards are white with a subtle border + soft shadow; pills mark the feature set; the traction bars are gradient-filled with a value above and a month label below.
- The ask slide flips to a full gradient box with white text and a heavy colored shadow.
- Fonts: Inter / Noto Sans SC for body and display, Playfair Display for the big serif question, JetBrains Mono for mono. Snappy fade-up animations on hero copy.
...
<div class="deck">
  ...
  <section class="slide" data-title="Cover">
    ...
    <h1 class="h1 anim-fade-up" data-anim="fade-up">The agentic browser<br>with a <span class="gradient-text">brain that remembers</span>.</h1>
    <p class="lede mt-m">One workspace where an on-device agent, your GBrain knowledge base, and live Canvas apps replace a dozen disconnected tabs.</p>
  ...
  <section class="slide" data-title="Problem">
    ...
    <h2 class="h2 mt-s">Knowledge workers drown<br>in 40+ tabs and forget everything.</h2>
    <div class="grid g3 mt-l">
      <div class="card"><h4>Context is lost</h4><p class="dim">Research, chats and docs scatter across tabs and apps. Nothing remembers what you learned yesterday.</p></div>
      <div class="card"><h4>Agents are blind</h4><p class="dim">Generic AI assistants can't see your pages, files or history, so every prompt starts from zero.</p></div>
      <div class="card"><h4>11 hrs / week lost</h4><p class="dim">Re-finding, re-reading and re-explaining instead of actually building.</p></div>
    </div>
  </section>
  ...
  <section class="slide" data-title="Solution">
    ...
    <h2 class="h2 mt-s">NevoFlux is <span class="gradient-text">one brain</span><br>for everything you browse.</h2>
    <p class="lede mt-m">Read a page → it lands in GBrain → the agent recalls it → it ships a Canvas app → your whole workspace stays in sync. In one browser. Without copy-paste.</p>
    <div class="row mt-l">
      <span class="pill pill-accent">GBrain</span>
      <span class="pill pill-accent">Agent</span>
  ...
  <section class="slide" data-title="Product">
    ...
    <div class="grid g2 mt-l">
      <div class="card card-hover"><h4>Remember everything</h4><p class="dim">GBrain captures every page, note and file into a private, on-device knowledge base you can query in plain language.</p></div>
      <div class="card card-hover"><h4>Act for you</h4><p class="dim">The agent reads the open tab, calls tools, and runs multi-step tasks grounded in your own context.</p></div>
      <div class="card card-hover"><h4>Build instantly</h4><p class="dim">Canvas turns a prompt into a live mini-app — dashboards, forms, viewers — right inside the browser.</p></div>
      <div class="card card-hover"><h4>Extend with packs</h4><p class="dim">Install design skills and packs, or ship your own via the SDK. The browser learns new tricks on demand.</p></div>
    </div>
  </section>
  ...
  <section class="slide" data-title="Market">
    ...
    <h2 class="h2 mt-s">The browser is the new OS.</h2>
    <div class="grid g3 mt-l">
      <div class="metric"><div class="n">1.4B</div><div class="l">knowledge workers in the browser daily</div></div>
      <div class="metric"><div class="n">$92B</div><div class="l">TAM · AI productivity + browser tooling</div></div>
      <div class="metric"><div class="n">21%</div><div class="l">CAGR through 2030</div></div>
    </div>
    <p class="lede mt-l">Researchers, builders, analysts, operators — the people who live in 30 tabs a day and have been waiting for a browser that actually thinks with them.</p>
  </section>
  ...
  <section class="slide" data-title="Business Model">
    ...
    <h2 class="h2 mt-s">Flat SaaS + pack marketplace.</h2>
    <div class="grid g3 mt-l">
      <div class="card"><h4>Personal</h4><div class="metric mt-s"><div class="n" style="font-size:56px">$19</div><div class="l">/ month · GBrain + agent, on-device</div></div></div>
      <div class="card card-accent"><h4>Pro</h4><div class="metric mt-s"><div class="n" style="font-size:56px">$49</div><div class="l">/ month · Canvas, SDK, team sync</div></div></div>
      <div class="card"><h4>+ Marketplace</h4><div class="metric mt-s"><div class="n" style="font-size:56px">20%</div><div class="l">take rate on paid packs &amp; skills</div></div></div>
    </div>
    <p class="dim mt-l">Blended LTV $2,160 · CAC payback 6 months at current funnel.</p>
  </section>
  ...
  <section class="slide" data-title="Traction">
    ...
    <h2 class="h2 mt-s">6 months, growing 41% MoM.</h2>
    <div class="traction-bar mt-l">
      <div class="bar" style="height:18%"><em>$7k</em><span>Oct</span></div>
      <div class="bar" style="height:30%"><em>$13k</em><span>Nov</span></div>
      <div class="bar" style="height:44%"><em>$20k</em><span>Dec</span></div>
      <div class="bar" style="height:62%"><em>$31k</em><span>Jan</span></div>
      <div class="bar" style="height:82%"><em>$46k</em><span>Feb</span></div>
      <div class="bar" style="height:100%"><em>$64k</em><span>Mar</span></div>
    </div>
    <p class="dim mt-l" style="margin-top:48px">3,180 paying users · NPS 74 · Net retention 121%</p>
  </section>
  ...
  <section class="slide" data-title="Team">
    ...
    <div class="grid g3 mt-l">
      <div class="card team-card"><div class="avatar">SA</div><h4>Samuel Ananke</h4><p class="dim">CEO · ex-browser platform lead. 9 yrs in runtimes and extensions.</p></div>
      <div class="card team-card"><div class="avatar">RP</div><h4>Raj Patel</h4><p class="dim">CTO · ex-search infra. Built on-device retrieval at 10M users.</p></div>
      <div class="card team-card"><div class="avatar">EK</div><h4>Elena Kim</h4><p class="dim">Head of Design · ex-Notion. Shipped the Canvas app system.</p></div>
    </div>
  </section>
  ...
  <section class="slide" data-title="The Ask">
    ...
    <div class="ask-box mt-m">
      <h2 class="h2">Raising $5M seed.</h2>
      <p class="lede" style="color:rgba(255,255,255,.9);max-width:60ch">18 months of runway to reach $4M ARR. 45% engineering, 30% growth, 15% on-device model R&amp;D, 10% runway buffer.</p>
      <div class="row mt-l" style="gap:40px">
        <div><div style="font-size:44px;font-weight:900">$5M</div><div class="dim">SAFE · post-money cap $32M</div></div>
        <div><div style="font-size:44px;font-weight:900">18 mo</div><div class="dim">runway to Series A</div></div>
        <div><div style="font-size:44px;font-weight:900">$4M</div><div class="dim">ARR target by close</div></div>
      </div>
    </div>
  </section>
...
A 10-slide deck, one beat per `section.slide`; fill the visible text and keep all CSS, class names, sizing, and structure unchanged.

- Cover (slide 1): set the `.brand` name, the `.kicker` round / year, the `.h1` tagline (wrap a phrase in `.gradient-text` for the gradient accent), the `.lede` one-liner, and the footer byline + `data-total` slide count.
- Section slides (2-8): each has a giant ghosted `.section-num`, a `.num-tag` label, an `.h2` headline, and either `.card` grids, `.metric` figures, or the `.traction-bar` (set each bar's `height:%`, the `<em>` value, and the `<span>` month label).
- Ask (slide 9): the `.ask-box` is the full-gradient highlight — set the raise amount in `.h2`, the use-of-funds in the `.lede`, and the three figure / label pairs.
- Thanks (slide 10): the `.mega` closing word, the `.mega-sub` contact line, and the closing pills.
- Keep it self-contained — no external URLs; gradients and the blurred `.cover-blob` are pure CSS.
