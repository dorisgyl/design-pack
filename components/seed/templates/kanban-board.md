---
slug: packs/design-pack/templates/kanban-board
type: template
lang: en
category: dashboard
title: "NevoFlux Kanban Board"
title_zh: "看板 / Kanban"
description: "Single-page Trello-style Kanban: filter bar, four status columns of cards with labels/avatars, and a sprint-pulse sidebar."
tags: [kanban, trello, sprint, 看板, template]
sample_image: packs/design-pack/assets/templates/kanban-board.svg
source: html-anything/kanban-board
---
## Design guidance

A Trello-style Kanban board on a single page. Intent: a sprint board viewed on desktop (target width 1440).

Layout:
- Top filter bar with assignee avatars, label chips, and a search field.
- Four columns: Backlog / In progress / In review / Done.
- Each card carries a label tag, a title, a due/points marker, an assignee avatar, and an issue id (think comment count too).
- Optional swimlanes that group cards by epic or assignee.
- A right sidebar holds the sprint pulse: completion progress, top contributors, and a blocked-ticket callout.

Design details:
- Warm, low-contrast neutral background with white surfaces and one violet accent used sparingly.
- It does not need real drag-and-drop, but the cards should look draggable (grab cursor, hover lift, dashed "new card" slots).
- Label tags are small uppercase mono chips, color-coded per type (Feature, Bug, Design, Chore, Research).
- Avatars are gradient circles with initials; progress bars are thin pills that fill with the accent gradient.
- Everything is self-contained: gradients and inline shapes only, no external assets.
...
<title>Canvas Squad · Sprint 12 Board</title>
<style>
  :root {
    --bg: #f7f7f9;
    --paper: #ffffff;
...
<div class="app">
  <main>
    <div class="topbar">
      <span class="crumb">NevoFlux / Canvas squad</span>
      <span class="sprint-chip"><span class="dot"></span>Sprint 12 · Day 6 of 10</span>
    ...
    <div class="board">
      <div class="col">
        ...
        <div class="card">
          ...
          <div class="card-title">Add empty-state illustration to the Canvas app gallery</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-dev">DP</span><span class="pts">3 pts</span></div><span>NF-241</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-design">Design</span>
          <div class="card-title">Refresh GBrain source-settings page tokens</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-mira">MR</span><span class="pts">2 pts</span></div><span>NF-237</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-research">Research</span>
          <div class="card-title">Interview 5 pack authors about the agent SDK onboarding</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-pri">PB</span><span class="pts">5 pts</span></div><span>NF-225</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-chore">Chore</span>
          <div class="card-title">Migrate legacy GBrain index to the new schema</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-cale">CA</span><span class="pts">3 pts</span></div><span>NF-219</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-bug">Bug</span>
          <div class="card-title">Pack export drops emoji from Canvas app names</div>
          <div class="card-meta"><div class="left"><span class="av-sm">+</span><span class="pts">1 pt</span></div><span>NF-244</span></div>
        </div>
      ...
      <div class="col">
        ...
        <div class="card">
          <span class="card-tag tag-feat">Feature</span>
          <div class="card-title">GBrain source connector UI in workspace settings</div>
          <div class="progress"><span style="width: 70%"></span></div>
          <div class="card-meta"><div class="left"><span class="av-sm av-dev">DP</span><span class="pts">5 pts</span></div><span>NF-201</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-feat">Feature</span>
          <div class="card-title">Agent SDK keys — generate, copy, revoke</div>
          <div class="progress"><span style="width: 45%"></span></div>
          <div class="card-meta"><div class="left"><span class="av-sm av-pri">PB</span><span class="pts">3 pts</span></div><span>NF-202</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-bug">Bug</span>
          <div class="card-title">Fix focus-trap regression in the Canvas command bar</div>
          <div class="progress"><span style="width: 80%"></span></div>
          <div class="card-meta"><div class="left"><span class="av-sm av-cale">CA</span><span class="pts">2 pts</span></div><span>NF-238</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-design">Design</span>
          <div class="card-title">Design-pack install step — visual + microcopy</div>
          <div class="progress"><span style="width: 30%"></span></div>
          <div class="card-meta"><div class="left"><span class="av-sm av-mira">MR</span><span class="pts">3 pts</span></div><span>NF-205</span></div>
        </div>
      </div>
      ...
      <div class="col">
        ...
        <div class="card">
          <span class="card-tag tag-feat">Feature</span>
          <div class="card-title">Audit-log entries for GBrain re-index events</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-pri">PB</span><span class="pts">2 pts</span></div><span>NF-198</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-design">Design</span>
          <div class="card-title">Browser sidebar restructure (left rail)</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-mira">MR</span><span class="pts">3 pts</span></div><span>NF-189</span></div>
        </div>
        <div class="card">
          <span class="card-tag tag-bug">Bug</span>
          <div class="card-title">Workspace switcher resets scroll on close</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-cale">CA</span><span class="pts">1 pt</span></div><span>NF-233</span></div>
        </div>
      </div>
      ...
      <div class="col">
        ...
        <div class="card" style="opacity: 0.85;">
          <span class="card-tag tag-feat">Feature</span>
          <div class="card-title">Workspace pack-publishing policy (admin)</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-dev">DP</span><span class="pts">5 pts</span></div><span>NF-181</span></div>
        </div>
        <div class="card" style="opacity: 0.85;">
          <span class="card-tag tag-chore">Chore</span>
          <div class="card-title">Bump agent SDK to 4.2.0</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-cale">CA</span><span class="pts">1 pt</span></div><span>NF-176</span></div>
        </div>
        <div class="card" style="opacity: 0.85;">
          <span class="card-tag tag-research">Research</span>
          <div class="card-title">Canvas app usability sessions (n=8)</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-pri">PB</span><span class="pts">3 pts</span></div><span>NF-172</span></div>
        </div>
        <div class="card" style="opacity: 0.85;">
          <span class="card-tag tag-design">Design</span>
          <div class="card-title">Design-pack tokens audit</div>
          <div class="card-meta"><div class="left"><span class="av-sm av-mira">MR</span><span class="pts">2 pts</span></div><span>NF-168</span></div>
        </div>
      </div>
    </div>
  </main>
    ...
    <div class="pulse">
      ...
      <div>
        ...
        <div class="pill-block">
          ...
          <p style="margin: 6px 0 0; color: var(--muted); font-size: 12.5px;">NF-205 (design-pack install step) is waiting on a copy review from Brand. Mention @Sasha or move it back to backlog.</p>
        </div>
      </div>
    </div>
  </aside>
...
- `topbar` — breadcrumb (workspace / squad), the sprint chip (number + day count), search field, and Filter / New buttons.
- `filterbar` — member avatars (gradient circles with initials), label chips (add `active` to highlight one), and trailing Group / Sort chips.
- `board` — four `col` blocks (Backlog / In progress / In review / Done); each `col-head` has a colored `swatch` and a `col-count`.
- `card` — one ticket: a `card-tag` (`tag-feat` / `tag-bug` / `tag-design` / `tag-chore` / `tag-research`), a `card-title`, optional `progress` bar, an assignee `av-sm`, a `pts` marker, and an issue id.
- `add-card` — dashed "new card" slot at the bottom of a column.
- `sidebar` — sprint pulse (completion bar), top contributors list, and a `pill-block` blocked-ticket callout.
