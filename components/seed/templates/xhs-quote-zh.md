---
slug: packs/design-pack/templates/xhs-quote-zh
type: template
lang: zh
category: xhs-card
title: "小红书图文 · 金句页"
title_zh: "小红书图文 · 金句页"
description: "居中的一句大号衬线金句，含一处荧光笔短语和一个强调色关键词，配一行小注。用来被'截图转发'的页。1080×1440。"
...
这页把标题字换成衬线——它是唯一该有'刊物感'而非'界面感'的页。一句话、最多两处强调（荧光笔 + 强调色关键词）。其余全是留白。若一行要断三次以上才放得下，就是太长了。
...
<body>
  <div class="qwrap">
    <div class="eyebrow">金句 · 一句话记住</div>
    <blockquote class="quote">笔记不是存放过去的<span class="mark">仓库</span>，<br>而是会替你增值的<br><em>资产</em>。</blockquote>
    <div class="src">用了三年笔记之后，最深的一点体会</div>
  </div>
  <div class="foot"><span><b>@效率手账</b></span><span>3 / 5</span></div>
</body>
</html>
