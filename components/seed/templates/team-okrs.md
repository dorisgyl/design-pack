---
slug: packs/design-pack/templates/team-okrs
type: template
lang: en
category: dashboard
title: "NevoFlux Team OKRs"
title_zh: "团队 OKR 追踪"
description: "Quarterly OKR tracker: quarter banner, 3 objectives with key-result progress bars, owners, status pills, and an at-a-glance sidebar."
tags: [okr, objectives, key results, 目标, template]
sample_image: packs/design-pack/assets/templates/team-okrs.svg
source: html-anything/team-okrs
---
## Design guidance

An OKR tracking page where progress reads at a glance. Intent: a single desktop view (target width 1440) that shows where the quarter stands.

Layout:
- A quarter banner at the top (Q? + theme) with the overall percentage on the right.
- Three objective columns/cards stacked down the main area, each holding a set of key results.
- Each key result gets one progress bar plus a value, an owner avatar, and a status pill.
- A right-hand "this quarter at a glance" sidebar summarizing the state.

Design details:
- Low-contrast neutral background with white surfaces and a single blue accent used sparingly.
- The quarter banner is a dark diagonal gradient with a large light-blue percentage figure.
- Objective cards carry a mono uppercase number, a title, an owner avatar (gradient fill), and a colored status pill (on-track / at-risk / off-track).
- Key-result bars are thin rounded tracks with a gradient fill that shifts color (blue / amber / red) to mirror the status, keeping the page self-contained with no external assets.
- The sidebar uses dashed dividers, mono numerics, top movers with deltas, and a tinted blocker callout.
...
<title>NevoFlux · Q4 FY25 OKRs</title>
<style>
  :root {
    --bg: #f5f6f9;
    --paper: #ffffff;
...
<div class="app">
  <main>
    <div class="crumb">NevoFlux / OKRs / FY25 / Q4</div>
    <div class="quarter-banner">
      <div>
        <h1>Q4 FY25 · NevoFlux</h1>
    ...
    <section class="objectives">
      <article class="obj">
        <div class="obj-head">
          <div class="obj-title"><span class="obj-num">Objective 1</span><span class="obj-name">Make the NevoFlux browser feel inevitable to the agentic-team buyer.</span></div>
          <div class="obj-owner"><span class="av av-mr">MR</span>Mira Reddy</div>
          <span class="pill on-track"><span class="dot"></span>On track</span>
        </div>
        <div class="krs">
          <div class="kr">
            <div class="kr-name"><strong>Convert 3 of 3 stalled platform pilots</strong><small>GBrain quota blocker · sales: Devon</small></div>
            <div class="kr-bar"><span class="kr-fill" style="width: 67%"></span></div>
            <div class="kr-pct">2 of 3</div>
          </div>
          <div class="kr">
            <div class="kr-name"><strong>Reach SOC 2 Type II readiness for GBrain</strong><small>controls: 14 / 16 implemented</small></div>
            <div class="kr-bar"><span class="kr-fill" style="width: 88%"></span></div>
            <div class="kr-pct">88%</div>
          </div>
          <div class="kr">
            <div class="kr-name"><strong>Ship workspace SSO + agent token scoping</strong><small>M3 lands Dec 2 · Devon</small></div>
      ...
      <article class="obj">
        <div class="obj-head">
          <div class="obj-title"><span class="obj-num">Objective 2</span><span class="obj-name">Cut time-to-first-Canvas-app for new workspaces in half.</span></div>
          <div class="obj-owner"><span class="av av-dp">DP</span>Devon Park</div>
          <span class="pill at-risk"><span class="dot"></span>At risk</span>
        </div>
        <div class="krs">
          <div class="kr">
            <div class="kr-name"><strong>Median time to first Canvas app ≤ 30 min</strong><small>baseline 72 min · current 47 min</small></div>
            <div class="kr-bar"><span class="kr-fill warn" style="width: 64%"></span></div>
            <div class="kr-pct">64%</div>
          </div>
          <div class="kr">
            <div class="kr-name"><strong>Activation rate ≥ 50% of new workspaces</strong><small>current 38% · last quarter 29%</small></div>
            <div class="kr-bar"><span class="kr-fill warn" style="width: 76%"></span></div>
            <div class="kr-pct">76%</div>
          </div>
          <div class="kr">
            <div class="kr-name"><strong>Ship the GBrain onboarding pack to 100%</strong><small>currently at 25% experiment</small></div>
      ...
      <article class="obj">
        <div class="obj-head">
          <div class="obj-title"><span class="obj-num">Objective 3</span><span class="obj-name">Make the agent SDK feel native to every Canvas builder.</span></div>
        ...
        <div class="krs">
          <div class="kr">
            <div class="kr-name"><strong>SDK-built Canvas apps as % of total ≥ 35%</strong><small>current 22% · last quarter 19%</small></div>
            <div class="kr-bar"><span class="kr-fill danger" style="width: 22%"></span></div>
            <div class="kr-pct">22%</div>
          </div>
          <div class="kr">
            <div class="kr-name"><strong>Ship redesigned SDK + design-skill surfaces</strong><small>scope locked Nov 1 · build started</small></div>
            <div class="kr-bar"><span class="kr-fill danger" style="width: 18%"></span></div>
            <div class="kr-pct">18%</div>
          </div>
          <div class="kr">
            <div class="kr-name"><strong>Pack marketplace rating ≥ 4.6 (currently 4.2)</strong><small>10-week rolling, requires sustained release cadence</small></div>
  ...
  <aside class="side">
    ...
    <div class="mover"><span class="av av-mr" style="width:24px;height:24px;font-size:9.5px;">MR</span><span>Platform pilot #2 — converted</span><span class="delta">+33%</span></div>
    <div class="mover"><span class="av av-dp" style="width:24px;height:24px;font-size:9.5px;">DP</span><span>Activation rate · GBrain funnel</span><span class="delta">+9 pp</span></div>
    <div class="mover"><span class="av av-pb" style="width:24px;height:24px;font-size:9.5px;">PB</span><span>SDK quickstart completion</span><span class="delta down">−2.4%</span></div>

    <h3>Blockers</h3>
    <div class="blocker">
      <strong>Agent SDK O3 is off-track.</strong>
      <p>Two engineers were borrowed for the SSO push. Either we drop the design-skill surfaces from O3, or we backfill with contractors by Nov 4. Decision needed Friday.</p>
    </div>
  </aside>
</div>
</body>
...
- **Quarter banner**: set the quarter label and theme in `h1`, the date range / owner / counts in `.meta`, and the headline progress in `.qb-progress .num` with a context line in `.label`.
- **Objectives**: each `.obj` is one objective. Fill `.obj-num`, `.obj-name`, the owner avatar (`.av` initials + gradient class) and `.obj-owner` name, and pick the status pill (`on-track` / `at-risk` / `off-track`).
- **Key results**: each `.kr` is one KR — `strong` is the result, `small` is the mono sub-note, the `.kr-fill` width plus its color class (`warn` / `danger`) drive the bar, and `.kr-pct` is the right-aligned value.
- **Sidebar**: `.stat` rows for the at-a-glance summary (`up` / `down` color the value), `.mover` rows for weekly movers with a `.delta` (add `down` for negatives), and one `.blocker` callout for the active risk.
