---
slug: packs/design-pack/templates/gamified-app
type: template
lang: en
category: mobile
title: "Gamified App — NevoFlux Quests"
title_zh: "游戏化 App 多屏"
description: "Three phone screens for an RPG-style habit app: cover, today's quests with an XP ribbon, and a quest detail view, on a dark showcase stage."
tags: [gamified, habit, rpg, quest, xp, template]
sample_image: packs/design-pack/assets/templates/gamified-app.svg
source: html-anything/gamified-app
---
## Design guidance

A gamified, RPG-style quest UI. Intent: a habit-building app rendered as three iPhone frames standing on a dark showcase stage.

Layout:
- Frame 1: Cover / poster.
- Frame 2: Today's quests, plus an XP ribbon and a level bar.
- Frame 3: Quest detail (sub-tasks and rewards).

Design details:
- Bold quest tiles built from soft pastel gradients, a level ribbon, and a bottom tab bar.
- Dark stage background with a warm radial glow so the phones read as a product showcase.
- Each phone is a self-contained frame (notch, status bar, rounded screen) with no external assets — gradients and inline shapes only.
...
<head>
  ...
  <title>NevoFlux — daily quests for shipping better software</title>
    ...
    <div class="phone" data-od-id="phone-cover">
      <div class="screen cover">
        ...
        <div class="body">
          ...
          <h1>Daily quests for <span class="accent">shipping</span> better software.</h1>
          <p class="lede">NevoFlux turns the things you already mean to do — index a GBrain source, ship a Canvas app, review an agent run, polish a design pack — into a daily quest log. Finish them, earn XP, watch your workspace level up.</p>
    ...
    <div class="phone" data-od-id="phone-home">
      <div class="screen home">
        ...
        <div class="level-ribbon" data-od-id="level-ribbon">
          <div class="lv">14</div>
          <div class="meta"><div class="label">LEVEL</div><div class="name">Builder · Lv 14</div></div>
        ...
        <div class="quests" data-od-id="quests">
          <div class="q q1">
            ...
            <div class="meta">Index 3 new docs into the knowledge base</div>
            <span class="xp">+90</span>
          </div>
          <div class="q q2">
            <div class="glyph">C</div>
            <p class="title">Canvas</p>
            <div class="meta">Ship the onboarding Canvas app</div>
            <span class="xp">+60</span>
          </div>
          <div class="q q3">
            <div class="glyph">A</div>
            <p class="title">Agent</p>
            <div class="meta">Review last night's agent runs</div>
            <span class="xp">+50</span>
          </div>
          <div class="q q4">
            <div class="glyph">P</div>
            <p class="title">Packs</p>
            <div class="meta">Publish the analytics pack v2</div>
            <span class="xp">+70</span>
          </div>
          <div class="q q5">
            <div class="glyph">D</div>
            <p class="title">Design</p>
            <div class="meta">Apply a design-pack skill to the deck</div>
            <span class="xp">+40</span>
          </div>
          <div class="q q6">
            <div class="glyph">S</div>
            <p class="title">SDK</p>
            <div class="meta">Wire one tool into the agent SDK</div>
    ...
    <div class="phone" data-od-id="phone-detail">
      <div class="screen detail">
        ...
        <div class="hero">
          ...
          <span class="badge">— GBRAIN · INDEXING</span>
          <h2>20 minutes that grow your brain.</h2>
          <p>A short, repeatable indexing block — add three sources, tag them, and run one verification query in the NevoFlux browser. Sam, you've finished this 11 times this month.</p>
        </div>
        <div class="steps" data-od-id="steps">
          <h3>Today's micro-tasks</h3>
          <div class="step done"><div class="check"></div><div class="name">Open the GBrain panel</div><div class="meta">+5 XP</div></div>
          <div class="step"><div class="check"></div><div class="name">Add 3 new sources</div><div class="meta">+30 XP</div></div>
          <div class="step"><div class="check"></div><div class="name">Tag &amp; group them</div><div class="meta">+30 XP</div></div>
          <div class="step"><div class="check"></div><div class="name">Run a verification query</div><div class="meta">+25 XP</div></div>
        </div>
...
- `stage-bar` — the top stage label; the centered `word` is the NevoFlux wordmark.
- `phone-cover` — Frame 1 poster: `eyebrow` chip, big serif `h1` headline (wrap one word in `.accent`), a `lede` paragraph, a mono `tip`, and a `next-peek` strip teasing the next screen.
- `phone-home` — Frame 2 dashboard: greeting `head`, the `level-ribbon` (level number, name, XP fraction, and the `.bar > span` width = progress), a `sub` summary line, and a 6-tile `quests` grid (`q1`–`q6` set each tile's gradient and glyph color).
- Each `.q` tile holds a single-letter `glyph`, a `title`, a `meta` line, and an `xp` reward badge.
- `phone-detail` — Frame 3 quest detail: `topbar` back row, a gradient `hero` (badge, headline, blurb, `stamp` reward), a `steps` list of micro-tasks (add class `done` to a `.step` to mark it complete), and a `start` CTA.
- `tabbar` — shared 5-slot bottom nav; the `center` slot is the round add button.
