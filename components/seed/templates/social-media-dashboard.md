---
slug: packs/design-pack/templates/social-media-dashboard
type: template
lang: en
category: dashboard
title: "NevoFlux Creator Analytics Dashboard"
title_zh: "社媒创作者仪表板"
description: "A dark, glassy creator-analytics console: channel switcher, follower/engagement KPIs, growth chart, top post, and trending topics."
tags: [social, creator, analytics, x, linkedin, tiktok, template]
sample_image: packs/design-pack/assets/templates/social-media-dashboard.svg
source: html-anything/social-media-dashboard
---
## Design guidance

A social-media analytics console aimed at bloggers and creators — here reframed around the NevoFlux community presence. Intent: a data dashboard for someone who publishes about the NevoFlux browser, GBrain knowledge base, and design packs. Target: desktop, 1440 wide.

Layout:
- Top channel switcher across the header (the original lists X / LinkedIn / YouTube / Instagram / TikTok; this build ships two live channels — the NevoFlux community account and the SDK repo).
- A row of KPI cards (followers / engagement rate / likes / reposts).
- A follower-growth line chart.
- A "top post this week" preview card.
- A side rail with trending topics and top comments.

Design details:
- Dark surface palette with a warm gold primary (`--primary-container`) and a teal-mint secondary used for accents, deltas, and glows.
- Glassmorphism throughout: translucent card backgrounds, `backdrop-filter` blur, hairline top-edge highlight gradients, and soft outer glows.
- Sticky header plus a sticky hero strip that restates the headline metric of the week.
- An "ask bar" placeholder for natural-language queries over the channel's posts.
- The growth chart, geography map, post thumbnail, and sparklines are all inline SVG over CSS gradients, so the page is fully self-contained with no external assets or fonts.
- KPI cards show an uppercase label, a large display value, a glowing up/down delta, and a small comparison footnote. Numbers tick live via a small interval that nudges each value by a believable amount.
...
<head>
  ...
  <title>NevoFlux · Creator Analytics</title>
  <style>
    :root {
      /* NevoFlux dark dashboard — bind palette */
      --surface: #121318;
      --surface-dim: #121318;
...
<body>
  ...
  <header data-od-id="header">
    <div class="header-left">
      <div class="logo-block">
        <svg class="brand-mark" viewBox="0 0 64 64" width="32" height="32" aria-label="NevoFlux">
      ...
      <div class="platform-switcher-inline">
        <button class="platform-pill active" data-platform="x">Community</button>
        <button class="platform-pill" data-platform="github">SDK Repo</button>
      </div>
    </div>
    <div class="header-right">
      ...
      <div class="user-block">
        <svg class="user-avatar" viewBox="0 0 64 64" aria-label="NevoFlux avatar">
        ...
        <div class="user-info">
          <div class="user-name">NevoFlux</div>
          <div class="user-role">Agentic browser · GBrain inside</div>
        </div>
      </div>
    </div>
  </header>
  ...
  <section class="hero-strip" data-od-id="hero">
    <div class="hero-content">
      <div class="hero-text">
        <h1 class="hero-headline" id="hero-headline">NevoFlux shipped 9 posts about the new Canvas this week.</h1>
        <p class="hero-meta" id="hero-meta">Engagement up 0.6% vs. last week · Top thread on GBrain reached 38K accounts</p>
      </div>
  ...
  <section class="ask-bar" data-od-id="ask">
    <input 
      ...
      class="ask-input" 
      id="ask-input"
      placeholder="Ask across your posts — 'top performing last week', 'replies mentioning GBrain'..."
    >
  </section>
  ...
  <div class="container">
    ...
    <div class="platform-cards" data-od-id="platform-switcher">
      <div class="platform-card active" data-platform-card="x">
        <div class="platform-card-header">
          ...
          <div>
            <div class="platform-name">Community</div>
            <div class="platform-handle">@nevoflux</div>
          </div>
        </div>
      </div>
      <div class="platform-card" data-platform-card="github">
        <div class="platform-card-header">
          <span class="platform-icon">⚙</span>
          <div>
            <div class="platform-name">SDK Repo</div>
            <div class="platform-handle">nevoflux/agent-sdk</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="main-grid">
      ...
      <div class="top-post-card" data-od-id="top-post">
        <div id="post-section">
          ...
          <div class="post-meta">
            <svg class="post-avatar" viewBox="0 0 64 64" aria-label="NevoFlux avatar">
              <circle cx="32" cy="32" r="30" fill="#1c1c20" stroke="url(#brandRing)" stroke-width="2.5"/>
              <path d="M22 22 L46 32 L26 36 L22 46 Z" fill="none" stroke="url(#brandRing)" stroke-width="2.4" stroke-linejoin="round" stroke-linecap="round"/>
            </svg>
          ...
          <div class="post-body" id="post-body">
            Canvas apps just shipped. Drop a pack into NevoFlux, ask GBrain a question, and watch a live app build itself. Video below.
          </div>
          <div class="post-media" aria-label="Video thumbnail">
            <svg viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice">
              ...
              <!-- Faint chart curve evoking the live Canvas app inside the video -->
    ...
    <div class="lower-grid">
      ...
      <div class="trending-card" data-od-id="trending">
        <h3 class="section-title" id="trending-title">Trending in AI × Browser</h3>
        <div id="trending-list">
          <div class="trending-row">
            <div>
              <span class="trending-name">gbrain</span>
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">canvas apps</span>
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">design packs</span>
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">agent sdk</span>
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">agentic browser</span>
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">skill seeds</span>
      ...
      <div class="comments-card" data-od-id="top-comments">
        ...
        <div id="comments-list">
          <div class="comment-item">
            ...
            <div class="comment-body">This is wild. GBrain pulled the whole spec out of my open tabs and the Canvas app just appeared. That's the level of craft I want from a browser.</div>
          ...
          <div class="comment-item">
            ...
            <div class="comment-body">Finally — a browser that doesn't feel like it was built by engineers for engineers. The design packs make every NevoFlux output look intentional. 🔥</div>
          ...
          <div class="comment-item">
            ...
            <div class="comment-body">Wired the NevoFlux agent SDK into our pipeline today. Went from prompt → working Canvas app in 90 seconds. This changes everything.</div>
  ...
  <script>
    // SDK repo contributors — rendered as inline initials so the page stays
    // self-contained with no external avatar requests.
    const githubContributors = [
      { login: "linhua", initials: "LH", contributions: 26 },
      { login: "marco-d", initials: "MD", contributions: 18 },
      { login: "sid-q", initials: "SQ", contributions: 17 },
      { login: "nettie", initials: "NT", contributions: 10 },
      { login: "kai-r", initials: "KR", contributions: 8 }
    ];

    // Channel data
    const platformData = {
      x: {
        heroHeadline: "NevoFlux shipped 9 posts about the new Canvas this week.",
        heroMeta: "Engagement up 0.6% vs. last week · Top thread on GBrain reached 38K accounts",
        heroCta: "New post →",
        askPlaceholder: "Ask across your posts — 'top performing last week', 'replies mentioning GBrain'...",
        kpis: [
        ...
        chartType: "smooth",
        chartAnnotations: [
          { x: 180, y: 120, label: "Canvas thread +412" },
          { x: 480, y: 60, label: "Launch week +1.1K" }
        ],
        postTag: "Click-through rate 5.8%",
        postBody: "Canvas apps just shipped. Drop a pack into NevoFlux, ask GBrain a question, and watch a live app build itself. Video below.",
        postEngagement: { likes: 312, reposts: 48, comments: 22 },
        trendingTitle: "Trending in AI × Browser",
        commentsTitle: "Top Comments · This Week"
      },
      github: {
        heroHeadline: "NevoFlux agent SDK hit 30K stars on GitHub — 9 days in.",
        ...
        postBody: "From 0 → 30K stars in 9 days. The NevoFlux agent SDK is the fastest-growing agent toolkit in GitHub history.",
    ...
    // Generate chart data based on channel
    function generateChartData(platform) {
      if (platform === 'x') {
        ...
        // Explosive star growth (9 days, steep curve)
        return [
          { x: 0, y: 250 },    // Day 0
          { x: 60, y: 240 },   // Day 1
          { x: 120, y: 220 },  // Day 2
...
Slots to fill when adapting this template:
- Header: brand mark, `logo-label`, the channel switcher pills, the time-range tabs, and the user block (name + role).
- Hero strip: the headline metric of the week (`#hero-headline`), a supporting `#hero-meta` line, and the two action buttons.
- Ask bar: placeholder copy for the natural-language query box.
- Channel cards: one card per channel (icon, name, handle); the active card mirrors the active header pill.
- KPI row: four cards (label, value, delta, footnote). Set `format: "int"` or `"percent"` per metric in `platformData`.
- Growth chart: title plus the `chartAnnotations` markers; data is generated in `generateChartData`.
- Audience geography: edit the `geo-stat` percentages; the dots and map are static inline SVG.
- Top post / contributors: the post preview (tag, handle, body, engagement) shows for the community channel; the repo channel swaps in the contributors grid (edit `githubContributors`).
- Lower grid: trending topics list (name + count + sparkline) and top comments (avatar initials, handle, body, engagement).
- All visuals are inline SVG over CSS gradients; the page ships with no external fonts, scripts, or images.
