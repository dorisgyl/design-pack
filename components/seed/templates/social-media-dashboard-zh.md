---
slug: packs/design-pack/templates/social-media-dashboard-zh
type: template
lang: zh
category: dashboard
title: "社媒创作者仪表板"
title_en: "NevoFlux Creator Analytics Dashboard"
description: "深色玻璃质感的创作者分析控制台:频道切换、粉丝/互动 KPI、增长曲线、热门帖子与趋势话题。"
tags: [social, creator, analytics, x, linkedin, tiktok, 模板]
sample_image: packs/design-pack/assets/templates/social-media-dashboard.svg
source: html-anything/social-media-dashboard
---
## 设计指导

面向博主与创作者的社媒数据分析控制台 —— 这里围绕 NevoFlux 的社区影响力重新构建。意图:为发布 NevoFlux 浏览器、GBrain 知识库与设计包内容的人打造一块数据看板。目标:桌面端,1440 宽。

布局:
- 顶部跨页眉的频道切换器(原版列出 X / LinkedIn / YouTube / Instagram / TikTok;本版上线两个实时频道 —— NevoFlux 社区账号与 SDK 仓库)。
- 一排 KPI 卡片(粉丝 / 互动率 / 点赞 / 转发)。
- 一张粉丝增长折线图。
- 一张「本周热门帖子」预览卡。
- 一条侧栏,展示趋势话题与热门评论。

设计细节:
- 深色表面调色板,搭配暖金色主色(`--primary-container`)与用于强调、增量与辉光的青薄荷次色。
- 全局玻璃拟态:半透明卡片背景、`backdrop-filter` 模糊、顶边发丝高光渐变,以及柔和的外发光。
- 吸顶页眉外加一条吸顶英雄条,重述本周的标志性指标。
- 一个「提问栏」占位符,用于对频道帖子进行自然语言查询。
- 增长图表、地理地图、帖子缩略图与迷你折线图全部是叠加在 CSS 渐变之上的内联 SVG,因此页面完全自包含,无任何外部资源或字体。
- KPI 卡片展示大写标签、超大显示数值、发光的上/下增量,以及小字对比脚注。数字通过一个小定时器实时跳动,以可信的幅度微调每个数值。
...
<body>
  ...
  <header data-od-id="header">
    <div class="header-left">
      <div class="logo-block">
        ...
        <span class="logo-label">数据分析</span>
      </div>
      <div class="platform-switcher-inline">
        <button class="platform-pill active" data-platform="x">社区</button>
        <button class="platform-pill" data-platform="github">SDK 仓库</button>
      </div>
    </div>
    <div class="header-right">
      <div class="time-range-tabs">
        <button class="time-tab active">7天</button>
        <button class="time-tab">30天</button>
        <button class="time-tab">90天</button>
        <button class="time-tab">年初至今</button>
      </div>
      <div class="user-block">
        ...
        <div class="user-info">
          ...
          <div class="user-role">智能体浏览器 · 内置 GBrain</div>
        </div>
      </div>
    </div>
  </header>
  ...
  <section class="hero-strip" data-od-id="hero">
    <div class="hero-content">
      <div class="hero-text">
        <h1 class="hero-headline" id="hero-headline">NevoFlux 本周发布了 9 条关于全新 Canvas 的帖子。</h1>
        <p class="hero-meta" id="hero-meta">互动率较上周提升 0.6% · 关于 GBrain 的热门话题触达 38K 账号</p>
      </div>
      <div class="hero-actions">
        <button class="btn btn-secondary">导出报告</button>
        <button class="btn btn-primary" id="hero-cta">发布新帖 →</button>
      </div>
    </div>
  </section>
  ...
  <section class="ask-bar" data-od-id="ask">
    <input 
      ...
      class="ask-input" 
      id="ask-input"
      placeholder="检索你的所有帖子 —— 「上周表现最佳」「提及 GBrain 的回复」……"
    >
  </section>
  ...
  <div class="container">
    ...
    <div class="platform-cards" data-od-id="platform-switcher">
      <div class="platform-card active" data-platform-card="x">
        <div class="platform-card-header">
          ...
          <div>
            <div class="platform-name">社区</div>
      ...
      <div class="platform-card" data-platform-card="github">
        <div class="platform-card-header">
          <span class="platform-icon">⚙</span>
          <div>
            <div class="platform-name">SDK 仓库</div>
    ...
    <div class="kpi-row" data-od-id="kpis">
      <div class="kpi-card">
        <div class="kpi-label" id="kpi-1-label">粉丝</div>
        <div class="kpi-value" id="kpi-1-value">14,287</div>
        <div class="kpi-delta">↗ <span id="kpi-1-delta">+2.3%</span></div>
        <div class="kpi-footnote" id="kpi-1-footnote">上周为 13,968</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" id="kpi-2-label">互动率</div>
        <div class="kpi-value" id="kpi-2-value">4.80%</div>
        <div class="kpi-delta">↗ <span id="kpi-2-delta">+0.4%</span></div>
        <div class="kpi-footnote" id="kpi-2-footnote">上周为 4.4%</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" id="kpi-3-label">点赞(7天)</div>
        <div class="kpi-value" id="kpi-3-value">1,842</div>
        <div class="kpi-delta">↗ <span id="kpi-3-delta">+18%</span></div>
        <div class="kpi-footnote" id="kpi-3-footnote">较上周 +280</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" id="kpi-4-label">转发(7天)</div>
        <div class="kpi-value" id="kpi-4-value">487</div>
        <div class="kpi-delta">↗ <span id="kpi-4-delta">+22%</span></div>
        <div class="kpi-footnote" id="kpi-4-footnote">较上周 +88</div>
      </div>
    </div>
    ...
    <div class="main-grid">
      ...
      <div class="chart-card" data-od-id="growth-chart">
        <h2 class="chart-header" id="chart-title">粉丝增长 · 30天</h2>
      ...
      <div class="geo-card" data-od-id="geo-distribution">
        <h2 class="chart-header">受众地理分布</h2>
        <div class="geo-map">
        ...
        <div class="geo-stats">
          <div class="geo-stat">
            <div class="geo-stat-label">北美</div>
            <div class="geo-stat-value">38%</div>
          </div>
          <div class="geo-stat">
            <div class="geo-stat-label">欧洲</div>
            <div class="geo-stat-value">31%</div>
          </div>
          <div class="geo-stat">
            <div class="geo-stat-label">亚太</div>
            <div class="geo-stat-value">22%</div>
          </div>
          <div class="geo-stat">
            <div class="geo-stat-label">其他</div>
      ...
      <div class="top-post-card" data-od-id="top-post">
        <div id="post-section">
          <div class="post-header-tag" id="post-tag">点击率 5.8%</div>
          <div class="post-meta">
            ...
            <div class="post-handle-block">
              ...
              <div class="post-timestamp">4 小时前</div>
            </div>
          </div>
          <div class="post-body" id="post-body">
            Canvas 应用正式上线。把一个设计包拖进 NevoFlux,向 GBrain 提一个问题,看着一个实时应用自己构建出来。视频见下方。
          </div>
          <div class="post-media" aria-label="Video thumbnail">
            ...
            <span class="post-media-caption">实时 · 0:22</span>
          </div>
        ...
        <div id="contributors-section" style="display: none;">
          <h3 class="section-title">核心贡献者</h3>
    ...
    <div class="lower-grid">
      ...
      <div class="trending-card" data-od-id="trending">
        <h3 class="section-title" id="trending-title">AI × 浏览器 趋势</h3>
        <div id="trending-list">
          <div class="trending-row">
            <div>
              <span class="trending-name">gbrain</span>
              <span class="trending-count">142 条帖子</span>
            </div>
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">canvas 应用</span>
              <span class="trending-count">98 条帖子</span>
            </div>
            <svg class="sparkline" viewBox="0 0 60 20">
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">设计包</span>
              <span class="trending-count">87 条帖子</span>
            </div>
            <svg class="sparkline" viewBox="0 0 60 20">
          ...
          <div class="trending-row">
            <div>
              ...
              <span class="trending-count">72 条帖子</span>
            </div>
            <svg class="sparkline" viewBox="0 0 60 20">
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">智能体浏览器</span>
              <span class="trending-count">64 条帖子</span>
            </div>
            <svg class="sparkline" viewBox="0 0 60 20">
          ...
          <div class="trending-row">
            <div>
              <span class="trending-name">技能种子</span>
              <span class="trending-count">58 条帖子</span>
            </div>
            <svg class="sparkline" viewBox="0 0 60 20">
      ...
      <div class="comments-card" data-od-id="top-comments">
        <h3 class="section-title" id="comments-title">热门评论 · 本周</h3>
        <div id="comments-list">
          <div class="comment-item">
            ...
            <div class="comment-body">太疯狂了。GBrain 从我打开的标签页里把整份规格抽了出来,Canvas 应用就这么直接出现了。这正是我对一款浏览器期待的工艺水准。</div>
          ...
          <div class="comment-item">
            ...
            <div class="comment-body">终于 —— 一款不再像是工程师为工程师打造的浏览器。设计包让每一个 NevoFlux 输出都显得用心而克制。🔥</div>
          ...
          <div class="comment-item">
            <div class="comment-meta">
              ...
              <span class="verified-badge">✓</span>
              <span class="comment-time">5 天前</span>
            </div>
            <div class="comment-body">今天把 NevoFlux agent SDK 接进了我们的流水线。从提示词到可用的 Canvas 应用只花了 90 秒。这彻底改变了一切。</div>
  ...
  <script>
    ...
    const platformData = {
      x: {
        heroHeadline: "NevoFlux 本周发布了 9 条关于全新 Canvas 的帖子。",
        heroMeta: "互动率较上周提升 0.6% · 关于 GBrain 的热门话题触达 38K 账号",
        heroCta: "发布新帖 →",
        askPlaceholder: "检索你的所有帖子 —— 「上周表现最佳」「提及 GBrain 的回复」……",
        kpis: [
          { label: "粉丝", value: 14287, format: "int", delta: "+2.3%", footnote: "上周为 13,968" },
          { label: "互动率", value: 4.8, format: "percent", delta: "+0.4%", footnote: "上周为 4.4%" },
          { label: "点赞(7天)", value: 1842, format: "int", delta: "+18%", footnote: "较上周 +280" },
          { label: "转发(7天)", value: 487, format: "int", delta: "+22%", footnote: "较上周 +88" }
        ],
        chartTitle: "粉丝增长 · 30天",
        chartType: "smooth",
        chartAnnotations: [
          { x: 180, y: 120, label: "Canvas 话题 +412" },
          { x: 480, y: 60, label: "上线周 +1.1K" }
        ],
        postTag: "点击率 5.8%",
        postBody: "Canvas 应用正式上线。把一个设计包拖进 NevoFlux,向 GBrain 提一个问题,看着一个实时应用自己构建出来。视频见下方。",
        postEngagement: { likes: 312, reposts: 48, comments: 22 },
        trendingTitle: "AI × 浏览器 趋势",
        commentsTitle: "热门评论 · 本周"
      },
      github: {
        heroHeadline: "NevoFlux agent SDK 在 GitHub 上达到 30K 星标 —— 仅用 9 天。",
        heroMeta: "爆发式增长:3 天 → 10K,9 天 → 30K · 累计 127 位贡献者",
        heroCta: "发布新版本 →",
        askPlaceholder: "检索你的仓库 —— 「陈旧的 PR」「标记为 good-first-issue 的议题」……",
        kpis: [
          { label: "星标", value: 30124, format: "int", delta: "+3,284%", footnote: "上线已 9 天" },
          { label: "复刻", value: 2847, format: "int", delta: "+412%", footnote: "第 3 天时为 556" },
          { label: "拉取请求(7天)", value: 38, format: "int", delta: "+156%", footnote: "本周已合并 18 个" },
          { label: "贡献者", value: 127, format: "int", delta: "+217%", footnote: "第 3 天时为 40" }
        ],
        chartTitle: "星标增长 · 爆发式轨迹(9天)",
        chartType: "explosive",
        chartAnnotations: [
          { x: 180, y: 180, label: "第 3 天 · 10K 星标" },
          { x: 540, y: 20, label: "第 9 天 · 30K 星标" }
        ],
        postTag: "127 位贡献者 · 30K 星标",
        postBody: "9 天内从 0 → 30K 星标。NevoFlux agent SDK 是 GitHub 历史上增长最快的智能体工具包。",
        postEngagement: { likes: 842, reposts: 217, comments: 94 },
        trendingTitle: "热门议题与讨论",
        commentsTitle: "热门议题回复 · 本周"
      }
    };
    ...
    function renderContributors() {
      ...
      githubContributors.forEach(contributor => {
        ...
        item.innerHTML = `
          ...
          <div class="contributor-commits">${contributor.contributions} 次提交</div>
        `;
...
适配此模板时需要填写的槽位:
- 页眉:品牌标识、`logo-label`、频道切换胶囊、时间范围标签,以及用户区块(名称 + 角色)。
- 英雄条:本周的标志性指标(`#hero-headline`)、一行辅助说明(`#hero-meta`),以及两个操作按钮。
- 提问栏:自然语言查询框的占位符文案。
- 频道卡片:每个频道一张卡片(图标、名称、账号);激活卡片与激活的页眉胶囊保持一致。
- KPI 行:四张卡片(标签、数值、增量、脚注)。在 `platformData` 中为每个指标设置 `format: "int"` 或 `"percent"`。
- 增长图表:标题加上 `chartAnnotations` 标注;数据在 `generateChartData` 中生成。
- 受众地理分布:编辑 `geo-stat` 百分比;圆点与地图是静态内联 SVG。
- 热门帖子 / 贡献者:帖子预览(标签、账号、正文、互动)在社区频道展示;仓库频道则换成贡献者网格(编辑 `githubContributors`)。
- 底部网格:趋势话题列表(名称 + 数量 + 迷你折线图)与热门评论(头像缩写、账号、正文、互动)。
- 所有视觉元素均为叠加在 CSS 渐变之上的内联 SVG;页面不附带任何外部字体、脚本或图片。
