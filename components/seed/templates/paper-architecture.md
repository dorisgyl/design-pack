---
slug: packs/design-pack/templates/paper-architecture
type: template
lang: en
category: paper-figure
title: "Paper Figure · Architecture (layer stack)"
title_zh: "论文图 · 架构图（分层堆叠）"
description: "A layered system-architecture figure: stacked labeled bands (Data ▸ Encode ▸ Core ▸ Output), each holding several module cards with icons, data flowing down through the stack."
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .title-pill{position:absolute;top:18px;left:50%;transform:translateX(-50%);background:#23357a;color:#fff;font-size:13.5px;font-weight:600;padding:7px 20px;border-radius:999px;box-shadow:var(--shadow);z-index:30;}
...
<div class="diagram-wrapper">
  <div class="diagram-canvas">
    <div class="title-pill">System architecture — layered view (data ▸ output)</div>
    ...
    <svg class="svg-layer" viewBox="0 0 1000 520">
      ...
      <use href="#ah" transform="translate(292,164) rotate(90)"/><use href="#ah" transform="translate(560,164) rotate(90)"/><use href="#ah" transform="translate(828,164) rotate(90)"/>
      <use href="#ah" transform="translate(292,270) rotate(90)"/><use href="#ah" transform="translate(560,270) rotate(90)"/><use href="#ah" transform="translate(828,270) rotate(90)"/>
      <use href="#ah" transform="translate(292,376) rotate(90)"/><use href="#ah" transform="translate(560,376) rotate(90)"/><use href="#ah" transform="translate(828,376) rotate(90)"/>
    </svg>

    <!-- LAYER 1 : DATA -->
    <div class="band" style="top:60px;background:var(--blue-t);"></div>
    <div class="tab" style="top:60px;background:var(--blue);"><b>Data</b><span>input</span></div>
    <div class="mod b-blue" style="left:174px;top:74px;width:236px;color:var(--blue);"><svg class="ic"><use href="#ic-dataset"/></svg><div class="tx"><span class="ml">Dataset</span><span class="ms">corpus · signals</span></div></div>
    <div class="mod b-blue" style="left:442px;top:74px;width:236px;color:var(--blue);"><svg class="ic"><use href="#ic-split"/></svg><div class="tx"><span class="ml">Tokenize · split</span><span class="ms">train / val / test</span></div></div>
    <div class="mod b-blue" style="left:710px;top:74px;width:236px;color:var(--blue);"><svg class="ic"><use href="#ic-augment"/></svg><div class="tx"><span class="ml">Augment</span><span class="ms">transform</span></div></div>

    <!-- LAYER 2 : ENCODE -->
    <div class="band" style="top:166px;background:var(--teal-t);"></div>
    <div class="tab" style="top:166px;background:var(--teal);"><b>Encode</b><span>represent</span></div>
    <div class="mod b-teal" style="left:174px;top:180px;width:236px;color:var(--teal);"><svg class="ic"><use href="#ic-embed"/></svg><div class="tx"><span class="ml">Embedding</span><span class="ms">vectorize</span></div></div>
    <div class="mod b-teal" style="left:442px;top:180px;width:236px;color:var(--teal);"><svg class="ic"><use href="#ic-encoder"/></svg><div class="tx"><span class="ml">Encoder ×N</span><span class="ms">stacked blocks</span></div></div>
    <div class="mod b-teal" style="left:710px;top:180px;width:236px;color:var(--teal);"><svg class="ic"><use href="#ic-pos"/></svg><div class="tx"><span class="ml">Positional</span><span class="ms">order signal</span></div></div>

    <!-- LAYER 3 : CORE -->
    <div class="band" style="top:272px;background:var(--red-t);"></div>
    <div class="tab" style="top:272px;background:var(--red);"><b>Core</b><span>model</span></div>
    <div class="mod b-red" style="left:174px;top:286px;width:236px;color:var(--red);"><svg class="ic"><use href="#ic-attn"/></svg><div class="tx"><span class="ml">Attention</span><span class="ms">re-weight</span></div></div>
    <div class="mod b-red" style="left:442px;top:286px;width:236px;color:var(--red);"><svg class="ic"><use href="#ic-experts"/></svg><div class="tx"><span class="ml">Experts (MoE)</span><span class="ms">route · fuse</span></div></div>
    <div class="mod b-red" style="left:710px;top:286px;width:236px;color:var(--red);"><svg class="ic"><use href="#ic-mem"/></svg><div class="tx"><span class="ml">Memory</span><span class="ms">state · cache</span></div></div>

    <!-- LAYER 4 : OUTPUT -->
    <div class="band" style="top:378px;background:var(--purple-t);"></div>
    <div class="tab" style="top:378px;background:var(--purple);"><b>Output</b><span>heads</span></div>
    <div class="mod b-purple" style="left:174px;top:392px;width:236px;color:var(--purple);"><svg class="ic"><use href="#ic-head"/></svg><div class="tx"><span class="ml">Task head</span><span class="ms">predict ŷ</span></div></div>
    <div class="mod b-purple" style="left:442px;top:392px;width:236px;color:var(--purple);"><svg class="ic"><use href="#ic-decoder"/></svg><div class="tx"><span class="ml">Decoder</span><span class="ms">generate</span></div></div>
    <div class="mod b-purple" style="left:710px;top:392px;width:236px;color:var(--purple);"><svg class="ic"><use href="#ic-loss"/></svg><div class="tx"><span class="ml">Loss ℒ</span><span class="ms">supervision</span></div></div>
  </div>
</div>
</body>
</html>
