---
slug: packs/design-pack/templates/deck-xhs-post-zh
type: template
lang: zh
category: slides
title: "小红书图文 Deck"
title_en: "Xiaohongshu Post Deck (NevoFlux)"
description: "9 页 3:4 竖版小红书 / Instagram 图文, 暖 pastel 背景 + 虚线 sticker 卡片。"
tags: [xhs, instagram, carousel, 模板]
...
布局
- Cover + N 个 content 页 + 收尾 CTA。N 由内容决定, 要完整覆盖每个要点; 短内容 7 页起步, 长内容应更多。受小红书平台单帖图片数约束, 建议总数不超过 18。
- 暖色 pastel 背景。
- 虚线 sticker 卡片 + 底部页码 dots。

设计细节
- 每页固定 810x1080 (3:4), 圆角卡片, 四角带柔和的 radial-gradient 光晕。
- 标题加粗超大; 正文用宽行距, 保证手机上也好读。
- 用手绘风 sticker 标签 (粉 / 黄 / 蓝 / 绿)、带数字的步骤圆圈, 以及带硬阴影偏移的 "hand-box" 卡片, 营造涂鸦感。
- 一页只讲一个核心点; 用 emoji + 一句短而有力的话开头。
...
<title>被一百个标签页淹没？让 NevoFlux 帮你读 · 小红书图文</title>
...
<div class="deck">
  ...
  <section class="slide" data-title="Cover">
    ...
    <div class="sticker pink" style="top:120px;left:48px;transform:rotate(-6deg)">😮‍💨 标签页爆炸</div>
    <div class="sticker yellow" style="top:140px;right:64px;transform:rotate(5deg)">亲测 7 天</div>
    <div style="margin-top:200px">
      <p class="lede" style="font-size:24px;color:var(--text-1);font-weight:600">收藏狂魔自救手册</p>
      <h1 class="h1 mt-s">别再被 <span class="cover-title">100 个标签页</span><br>淹没，让 <span class="cover-title">NevoFlux</span><br>帮你读</h1>
    </div>
    <div class="bottom-bar"><div><span class="avatar">N</span> <b style="color:var(--text-1);margin-left:8px">@NevoFlux日常</b></div><div>← 左滑 查看</div></div>
  </section>
  ...
  <section class="slide" data-title="Hook">
    ...
    <p class="lede tc mt-m" style="padding:0 20px">我也曾是那个<br>开着 80 个标签页"以防万一"的人。<br><br>直到我让<br><b style="color:var(--accent)">一个工具</b>帮我把它们都记住。</p>
  ...
  <section class="slide" data-title="Pain">
    ...
    <h2 class="h2 mt-s">标签越开越乱</h2>
    <div class="stack mt-l">
      <div class="hand-box"><b style="font-size:22px">🔖 47 个"稍后再看"</b><p class="dim" style="font-size:16px;margin-top:4px">再也没点开过，一个都没</p></div>
      <div class="hand-box"><b style="font-size:22px">🔍 在 12 个网页里翻找</b><p class="dim" style="font-size:16px;margin-top:4px">明明记得在哪看过</p></div>
      <div class="hand-box"><b style="font-size:22px">📋 复制粘贴到文档</b><p class="dim" style="font-size:16px;margin-top:4px">下周链接就失效了</p></div>
    </div>
  </section>
  ...
  <section class="slide" data-title="Aha">
    ...
    <h2 class="h2 mt-s">不是你记性差，<br>是<span style="background:var(--accent-3);padding:0 8px">浏览器太笨</span>。</h2>
    <p class="lede mt-l">NevoFlux 把你读过的每个网页<br>都存进 GBrain 这个内置知识库。<br>之后你只要用大白话问它就行。</p>
    <p class="lede mt-m" style="color:var(--text-1);font-weight:700">关键是：<span style="color:var(--accent)">读一次，随时调取</span>。</p>
  </section>
  ...
  <section class="slide" data-title="Step 1">
    ...
    <h2 class="h2 mt-m">照常浏览就好</h2>
    <div class="hand-box mt-l">
      <p style="font-size:22px;margin:0;color:var(--text-1);font-weight:700">👉 零额外操作</p>
      <p style="font-size:20px;margin:10px 0 0;color:var(--text-2);line-height:1.7">用 <b style="color:var(--accent)">NevoFlux 浏览器</b>打开网页，<br>GBrain 会默默把每一页都索引下来</p>
    </div>
    <div class="hand-box mt-m" style="background:#fff5ef">
      <p style="font-size:18px;margin:0;color:var(--text-2)">举例：看了 30 篇测评</p>
      <p style="font-size:24px;margin:8px 0 0;color:var(--text-1);font-weight:800">→ 30 篇全进 GBrain<br>→ 一处即可检索</p>
    </div>
  </section>
  ...
  <section class="slide" data-title="Step 2">
    ...
    <h2 class="h2 mt-m">直接问 agent</h2>
    <div class="hand-box mt-l">
      <p style="font-size:22px;margin:0;color:var(--text-1);font-weight:700">💬 "哪台笔记本续航最好？"</p>
      <p style="font-size:18px;margin:8px 0 0;color:var(--text-2);line-height:1.6">NevoFlux agent 会读你存过的网页，附来源直接作答，不用重新搜。哪怕那些标签页早就关掉了也照样能答。</p>
    </div>
    <div class="sticker yellow" style="bottom:200px;right:60px;transform:rotate(8deg)">⚡ 比搜索还快</div>
    <div class="hand-box mt-m" style="background:#fff5ef">
      <p style="font-size:18px;margin:0;color:var(--text-2)">懒人方案：</p>
      <p style="font-size:22px;margin:6px 0 0;color:var(--text-1);font-weight:700">打一句问题，回车 💬</p>
    </div>
  </section>
  ...
  <section class="slide" data-title="Step 3">
    ...
    <h2 class="h2 mt-m">一键生成<br>Canvas 应用</h2>
    <div class="hand-box mt-l">
      <p style="font-size:20px;margin:0;color:var(--text-2);line-height:1.6"><b style="color:var(--text-1)">🎨 一句话。</b>让它出个对比表，NevoFlux 就用 GBrain 里的笔记现场搭出一个 Canvas 应用。</p>
    </div>
    <div class="hand-box mt-m" style="background:#fff5ef">
      <p style="font-size:20px;margin:0;color:var(--text-2);line-height:1.6"><b style="color:var(--text-1)">💡 小 tip：</b>把这个 Canvas 应用存成 pack，下次直接复用，你的调研就变成了可复用的工具。</p>
    </div>
    <div class="sticker pink" style="bottom:140px;left:50%;transform:translateX(-50%) rotate(-3deg)">高手作弊技</div>
  </section>

  <!-- 8. Result -->
  <section class="slide" data-title="Result">
    <div class="page-dot">8 / 9</div>
    <p class="lede" style="color:var(--good);font-weight:700">✅ 用 NevoFlux 7 天后</p>
    <h2 class="h2 mt-s">结果是……</h2>
    <div class="stack mt-l">
      <div class="hand-box"><b style="font-size:22px">😌 标签从 80 个降到 6 个</b></div>
      <div class="hand-box"><b style="font-size:22px">💪 几秒就能翻到答案</b></div>
      <div class="hand-box"><b style="font-size:22px">🔖 不再囤一堆收藏夹</b></div>
      <div class="hand-box" style="background:var(--accent-3);border-color:var(--text-1)"><b style="font-size:24px">✨ 最重要：调研沉淀下来了</b></div>
    </div>
  </section>
  ...
  <section class="slide" data-title="CTA">
    ...
    <p class="lede tc mt-l" style="padding:0 30px">下期讲<br><b style="color:var(--text-1)">「5 个每天帮你省 1 小时的 NevoFlux pack」</b><br>搭一次，永久复用</p>
    <div class="tag-row" style="justify-content:center;margin-top:36px">
      <span class="ht">#NevoFlux</span>
      <span class="ht">#GBrain</span>
      <span class="ht">#AI浏览器</span>
      <span class="ht">#效率工具</span>
    </div>
    <div class="bottom-bar"><div><span class="avatar">N</span> <b style="color:var(--text-1);margin-left:8px">@NevoFlux日常</b></div><div>❤️ 5.2w</div></div>
  </section>
...
- 第 1 页 (Cover): 超大钩子标题 + 产品名; 两个倾斜的 sticker 标签, 底部 bar 放作者昵称。
- 第 2 页 (Hook): 一句"先别划走"+ 一个简短的亲身故事, 抛出一个大收益。
- 第 3 页 (Pain): "你是不是也这样"的痛点清单, 每个痛点一个 `hand-box`。
- 第 4 页 (Aha): 反转 / 洞察, 用 accent 底色高亮一个关键短语。
- 第 5-7 页 (Steps): 带数字的 `num-circle` + 每页一个方法; 一个 `hand-box` 讲公式 / 原理, 再配一个示例框。每步的圆圈分别用 `--accent`、`--accent-2`、`--accent-3` 换色。
- 第 8 页 (Result): 实践后的成果证明, 最后一个 `hand-box` 高亮作为金句。
- 第 9 页 (CTA): emoji + 收藏 / 关注号召, 预告下一期, `.tag-row` 里放话题标签。
- 把 `.page-dot` (`n / 总数`) 和结尾点赞数改成你的真实页数与数据。可在 Cover 和 CTA 之间增减 content 页以适配主题 (总数建议不超过 18)。
