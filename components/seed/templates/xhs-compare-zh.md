---
slug: packs/design-pack/templates/xhs-compare-zh
type: template
lang: zh
category: xhs-card
title: "小红书图文 · 对比页（✕ / ✓）"
title_zh: "小红书图文 · 对比页（✕ / ✓）"
description: "两栏对比：左为弱化的'✕ 多数人'，右为强调色浅底的'✓ 高手'，各三条。1080×1440。"
...
只给你想让人选的那栏上浅底强调色，另一栏保持安静的灰。两栏要对仗——条数相同、句长相近——让'对比'本身成为信息。每栏三条最好读。
...
<body>
  <div class="eyebrow">对比 · 少走三年弯路</div>
  <h2 class="h2">同样记笔记<br>差距在<span class="mark">这一步</span></h2>
  <div class="cmp">
    <div class="col bad">
      <div class="ch"><i>✕</i>多数人</div>
      <ul>
        <li>按软件功能分文件夹</li>
        <li>记完就再也不打开</li>
        <li>越积越多，越积越乱</li>
  ...
  <div class="foot"><span><b>@效率手账</b></span><span>4 / 5</span></div>
</body>
</html>
