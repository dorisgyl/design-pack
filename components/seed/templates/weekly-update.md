---
slug: packs/design-pack/templates/weekly-update
type: template
lang: en
category: slides
title: "Weekly Update Deck"
title_zh: "团队周报 Deck"
description: "A 6-8 page horizontal-swipe weekly status deck for a NevoFlux team: shipped / in flight / blocked / metrics / asks."
tags: [weekly, 周报, status, template]
...
A 6-8 page horizontal-swipe slide deck with the fixed structure of a team weekly report. One screen per slide, left/right keyboard navigation, and the URL hash kept in sync so a slide is shareable.

### Layout
- **Cover** - the week number, the team, and a one-line theme for the week.
- **Shipped** - a numbered list of what landed, each row tagged with its owner.
- **In flight** - work still moving, shown with owner avatars (the original uses an avatar row; a progress bar works equally well).
- **Blocked** - a single red/warm callout for the one thing that is stuck, plus an explicit ask.
- **Metrics** - a grid of KPI cards with sparkline charts and a week-over-week delta.
- **Asks** - a checklist of requests for the next week, one card per team.
- **Thanks** - a short closing slide with a signature.

### Design details
- Left / right arrow keys (and PageUp / PageDown) move between slides; navigation dots at the bottom jump directly to a slide.
- The deck snaps horizontally (`scroll-snap-type: x mandatory`) and hides its scrollbar.
- Dark paper palette with a warm-yellow accent and a violet secondary; mono font for crumbs, page numbers, and labels.
- Each slide carries a small crumb (top-left) and a `NN / total` page number (bottom-right).
- Charts are inline SVG sparklines with a gradient fill - no external assets or URLs.
...
<title>NevoFlux · Weekly update · W24</title>
<style>
  :root {
    --bg: #0e0d12;
    --paper: #19171f;
...
<div class="deck" id="deck">
  ...
  <!-- 1. Cover -->
  <section class="slide">
    <span class="crumb">NevoFlux GBrain · weekly</span>
    <div class="slide-inner cover">
      <div class="badge"><span class="dot"></span>Week 24 · 9 → 13 Jun</div>
      <h1>Hello, week <em>twenty&#8209;four</em>.</h1>
      <div class="meta">
  ...
  <section class="slide">
    ...
    <div class="slide-inner headline">
      <div class="headline-num">+22%<small>Net new GBrain captures vs Q1 weekly avg</small></div>
      <div class="headline-text">
        <h2>The week the browser started feeling fast again.</h2>
        <p>Canvas app launch completion is up 9 pp, capture→answer cut to 47 seconds from 1m12, and we shipped the first piece of the agent-SDK streaming workstream.</p>
      </div>
    </div>
  ...
  <section class="slide">
    ...
    <div class="slide-inner">
      ...
      <div class="item-list">
        <div class="item"><span class="item-num">01</span><span class="item-title">One-click GBrain capture from any browser tab</span><span class="item-meta">NF-201 · Devon</span></div>
        <div class="item"><span class="item-num">02</span><span class="item-title">Canvas app empty-state illustrations</span><span class="item-meta">NF-241 · Mira</span></div>
        <div class="item"><span class="item-num">03</span><span class="item-title">Citation trail for agent answers</span><span class="item-meta">NF-198 · Priya</span></div>
        <div class="item"><span class="item-num">04</span><span class="item-title">Pack-switcher scroll-reset fix</span><span class="item-meta">NF-233 · Caleb</span></div>
      </div>
    </div>
  ...
  <section class="slide">
    ...
    <div class="slide-inner">
      ...
      <div class="item-list">
        <div class="item"><span class="item-num">01</span><span class="item-title">Offline GBrain index — build, sync, rebuild</span><div class="av-row"><span class="av">PB</span></div></div>
        <div class="item"><span class="item-num">02</span><span class="item-title">Agent SDK streaming step — visual + microcopy</span><div class="av-row"><span class="av av-2">MR</span><span class="av">SL</span></div></div>
        <div class="item"><span class="item-num">03</span><span class="item-title">Canvas nav restructure (left rail)</span><div class="av-row"><span class="av av-2">MR</span></div></div>
        <div class="item"><span class="item-num">04</span><span class="item-title">Design-skill backlog dashboard</span><div class="av-row"><span class="av av-3">CA</span></div></div>
      </div>
    </div>
  ...
  <section class="slide">
    ...
    <div class="slide-inner">
      ...
      <div class="blocked-block">
        <h3>Design-skill copy review for the agent streaming step.</h3>
        <p>Sasha needs Design to review the new Canvas microcopy by Wednesday EOD or the v2.4 cut (Jun 25) slips. The doc is tagged in <code style="font-family: var(--mono);">#design-pack-reviews</code>; we just need eyes.</p>
        <span class="blocked-ask">Ask: Design — please review by Wed</span>
      </div>
    </div>
  ...
  <section class="slide">
    ...
    <div class="slide-inner">
      ...
      <div class="chart-grid">
        <div class="chart">
          <h4>Canvas launch rate · 4-week trailing</h4>
        ...
        <div class="chart">
          <h4>Capture-to-answer · median</h4>
          ...
          <div class="big-num" style="color: #b388ff;">47 sec</div>
          <div class="delta">▼ −25 sec this week</div>
        </div>
      </div>
    </div>
  ...
  <section class="slide">
    ...
    <div class="slide-inner">
      ...
      <div class="asks">
        <div class="ask">
          <div class="who"><span class="av av-2">SL</span>Design</div>
          <h3>Review the agent streaming microcopy by Wednesday EOD.</h3>
          <p>Doc is tagged in <code style="font-family: var(--mono);">#design-pack-reviews</code>. Without it, v2.4 ships late and the Pioneer rollout slips.</p>
        </div>
        <div class="ask">
          <div class="who"><span class="av av-3">PB</span>Platform</div>
          <h3>Pair on the offline-index rebuild rehearsal Thursday 14:00.</h3>
          <p>30 minutes. We want to dry-run the GBrain migration before we touch the shared index next sprint.</p>
        </div>
        <div class="ask">
          <div class="who"><span class="av">DP</span>Sales</div>
          <h3>Loop us in to the Pioneer pack-deployment call.</h3>
          <p>We can answer the agent-SDK questions live; will save a round-trip.</p>
        </div>
        <div class="ask">
          <div class="who"><span class="av av-2">MR</span>Research</div>
          <h3>Five recruits for the Canvas builder study by next Friday.</h3>
          <p>Existing NevoFlux users preferred. We have a recruit form ready in GBrain.</p>
        </div>
      </div>
    </div>
  ...
  <section class="slide">
    ...
    <div class="slide-inner closer">
      ...
      <p>Thanks for the focus. The agent-SDK push is paying off and the Canvas work landed harder than I expected. Special thanks to Mira for the empty-state work — small change, big lift on launch rate.</p>
      <div class="signature">
        <span class="av">DP</span>
        <div><strong>Devon Park</strong><span>GBrain squad lead · ping me in #gbrain-squad</span></div>
      </div>
    </div>
...
- **Cover slide** (`.cover`) — fill the `.badge` with the week number and date range, the `h1` with a one-line theme (`<em>` highlights the week), and the `.meta` row with author / audience / read time.
- **Headline slide** (`.headline`) — `.headline-num` is the single biggest number of the week with a `small` caption; `.headline-text` carries the narrative `h2` + supporting `p`.
- **Shipped / In flight** (`.item-list` + `.item`) — one row per item: a `.item-num`, an `.item-title`, then either an `.item-meta` owner tag (shipped) or an `.av-row` of owner avatars (in flight). Use `.av`, `.av-2`, `.av-3` to vary avatar colors.
- **Blocked slide** (`.blocked-block`) — a single warm callout: `h3` for the blocker, `p` for context, and `.blocked-ask` for the explicit ask. Keep it to one item.
- **Metrics slide** (`.chart-grid` + `.chart`) — each card has a title, a `.sub` direction hint, an inline SVG sparkline, a `.big-num`, and a `.delta` (add `.warn` for a negative move). Edit the `points` to reshape the line.
- **Asks slide** (`.asks` + `.ask`) — one card per team: `.who` (avatar + team), an `h3` request, and a `p` consequence.
- **Closer** (`.closer`) — a big "That's the week." statement, a thank-you `p`, and a `.signature` (avatar + name + handle).
- Page numbers (`.pageno`) and the nav dots are per-slide; update `NN / total` if you add or remove slides. Arrow keys / PageUp / PageDown and the dots both navigate.
