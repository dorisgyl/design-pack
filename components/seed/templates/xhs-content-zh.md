---
slug: packs/design-pack/templates/xhs-content-zh
type: template
lang: zh
category: xhs-card
title: "小红书图文 · 内容页（步骤 / 清单）"
title_zh: "小红书图文 · 内容页（步骤 / 清单）"
description: "内页内容页：小标题 + Notion 块式编号步骤清单 + 一个浅底提示块收尾。1080×1440。"
...
用于讲'怎么做'的页。编号只给真正有顺序的内容——若无序就用普通圆点。每页最多三到四个块；放不下就翻页，别把字号压小。提示块装那句最该被截图的话。
...
<body>
  <div class="eyebrow">工作流 01 · 收集</div>
  <h2 class="h2">每天 10 分钟<br>清空你的<span class="mark">收集箱</span></h2>
  <ul class="blocks">
    <li><span class="k">1</span><div><b>随手记，先不分类</b><p>灵感统一落进同一个收集箱，零摩擦，才真的记得下来。</p></div></li>
    <li><span class="k">2</span><div><b>每天定时清空</b><p>通勤路上把碎片归位到对应项目，十分钟就能清零。</p></div></li>
    <li><span class="k">3</span><div><b>归档即复习</b><p>整理这个动作本身，就是一次低成本的回顾。</p></div></li>
  </ul>
  <div class="callout"><span class="ico">✦</span><p>关键不是记得多，而是<b>每天都清零</b>——让收集箱始终可信。</p></div>
  <div class="foot"><span><b>@效率手账</b></span><span>2 / 5</span></div>
</body>
</html>
