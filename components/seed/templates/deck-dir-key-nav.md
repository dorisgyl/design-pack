---
slug: packs/design-pack/templates/deck-dir-key-nav
type: template
lang: en
category: slides
title: "Dir-Key Nav Minimal Deck"
title_zh: "极简方向键 Keynote"
description: "A minimal 8-page arrow-key keynote with monochrome backgrounds, 160px display titles, a 4px accent rule, and mono arrow lists."
tags: [minimal, kbd, monocolor, template]
sample_image: packs/design-pack/assets/templates/deck-dir-key-nav.svg
source: html-anything/deck-dir-key-nav
---

## Design guidance

A stripped-down keynote for the moment when "you have something to say but not much to show." The whole deck rides on typography and color, nothing else.

Layout:
- The page count is driven by the content. Short content starts at 8 pages; longer content should grow past that. Each slide gets a single solid background, cycled through the palette (indigo / cream / crimson / emerald / slate / violet / white / charcoal). Colors may repeat.
- A 160px display title paired with a short, thick 4px accent rule.
- A mono-font list, each item prefixed with an arrow (→).
- A keyboard hint with ← → in the bottom-left, and the page number in the bottom-right.
...
<div class="deck">
  ...
  <section class="slide t-indigo is-active">
    ...
    <div style="margin:auto 0">
      <div class="dk-eyebrow">NevoFlux Browser</div>
      <h1 class="dk-h0">Why tabs<br>can't hold a <span class="dk-accent">brain</span></h1>
      <span class="dk-line"></span>
      <p class="dk-lede">Eight backgrounds, eight slides — the shortest case for turning your browser into a <strong>persistent knowledge base</strong>. Press → to continue.</p>
    </div>
  ...
  <section class="slide t-cream">
    ...
    <div style="margin:auto 0">
      ...
      <span class="dk-line"></span>
      <p class="dk-lede">Your browser forgets everything the moment you close a tab. Every page you read leaves nothing behind.</p>
    </div>
  ...
  <section class="slide t-crimson">
    ...
    <div style="margin:auto 0">
      ...
      <h2 class="dk-h1">Four kinds of<br>browser<br><span class="dk-accent">amnesia</span>.</h2>
      <ul class="dk-list">
        <li>You research a topic for hours, then lose every link the next day</li>
        <li>Your AI assistant starts from zero in every single chat</li>
        <li>Notes, tabs, and bookmarks never talk to each other</li>
        <li>What you learned last week is unsearchable and gone</li>
      </ul>
    </div>
  ...
  <section class="slide t-emerald">
    ...
    <div style="margin:auto 0">
      ...
      <h2 class="dk-h1">The answer is<br>a <span class="dk-accent">GBrain</span>,<br>not more tabs.</h2>
      <p class="dk-lede" style="margin-top:10px">NevoFlux writes every page, highlight, and chat into a <strong>local knowledge base</strong>.<br>The agent reads from GBrain before it answers anything.</p>
      <div class="dk-grid-2">
        <div class="dk-col"><h3>× Open more tabs</h3><p>Pile up tabs you'll never reopen — slow, heavy, and eventually lost.</p></div>
        <div class="dk-col"><h3>✓ GBrain + retrieval</h3><p>Captured on the fly, recalled on demand, structured and searchable forever.</p></div>
      </div>
    </div>
  ...
  <section class="slide t-slate">
    ...
    <div style="margin:auto 0">
      ...
      <h2 class="dk-h2"><span class="dk-accent">4 lines</span> of YAML<br>to get started.</h2>
      <pre class="dk-code">gbrain:
  root: ~/.nevoflux/gbrain
  format: markdown
  retrieval: hybrid  # embedding + bm25</pre>
      <p class="dk-lede" style="margin-top:16px;font-size:20px">You now have a <strong>knowledge base that grows as you browse</strong>. Every session reads it and writes back to it.</p>
    </div>
  ...
  <section class="slide t-violet">
    ...
    <div style="margin:auto 0">
      ...
      <p class="dk-lede" style="margin-top:14px;font-size:26px">of repeated lookups disappear. The agent recalls from GBrain and saves an average of <strong>4.2 minutes</strong> per task.</p>
  ...
  <section class="slide t-white">
    ...
    <div style="margin:auto 0">
      ...
      <h2 class="dk-h1">Build<br>your <span class="dk-accent">GBrain</span>.</h2>
      <span class="dk-line"></span>
      <p class="dk-lede">It's not another extension. It's the decision that <strong>every page you visit feeds one shared knowledge base</strong> from tonight on.</p>
      <pre class="dk-code" style="font-size:18px">$ nevoflux init ~/gbrain
$ nevoflux pack add design-pack
$ nevoflux canvas new "my first app"</pre>
    </div>
  ...
  <section class="slide t-charcoal">
    ...
    <div style="margin:auto 0">
      ...
      <h1 class="dk-h0"><span class="dk-accent">Thank you</span>.</h1>
      <span class="dk-line"></span>
      <p class="dk-lede">The NevoFlux agent SDK and the full pack catalog ship in the browser. Press ← to rewind and walk through it again.</p>
    </div>
...
Each `<section class="slide t-...">` is one page; the `t-*` class picks its background from the palette. Fill these slots:
- `dk-snum` (top-right): running page index like `01 / 08`.
- `dk-eyebrow`: a short uppercase label (chapter, section name, or kicker).
- `dk-h0` / `dk-h1` / `dk-h2`: the display headline; wrap the key word in `<span class="dk-accent">`.
- `dk-line`: the 4px accent rule (no content).
- `dk-lede`: one or two sentences of body copy; emphasize with `<strong>`.
- `dk-list`: arrow-prefixed bullet items (mono font).
- `dk-grid-2` / `dk-col`: a two-column compare block.
- `dk-code`: a small mono code/config snippet.
- `dk-big` + `<svg>` bar: a single hero metric with a progress bar.
- `dk-keyhint` (bottom-left) and `dk-page` (bottom-right): navigation hint and page label.

Add or remove `<section>` blocks to change the page count, cycling the `t-*` palette classes as you go.
