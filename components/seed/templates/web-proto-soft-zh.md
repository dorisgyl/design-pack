---
slug: packs/design-pack/templates/web-proto-soft-zh
type: template
lang: zh
category: prototype
title: "Apple Soft 原型"
title_en: "Apple-tier Soft Prototype"
description: "Apple 调性的柔质感落地原型:银/奶色 canvas + 双层斜面卡片 + button-in-button CTA + spring 弹性动效。"
tags: [apple, soft, squircle, spring, 模板]
sample_image: packs/design-pack/assets/templates/web-proto-soft.svg
source: html-anything/web-proto-soft
---
## 设计指导

一个 Apple 级别的柔质感原型页。意图:用 squircle 几何、spring 弹性动效与环境网格背景,营造沉静、高级的产品落地页。

布局:
- 银 / 奶色 canvas,叠加缓慢漂移的环境网格背景(两团模糊的径向光晕)。
- 双层斜面卡片(double-bezel):外层壳体带柔和高光,内裹一层核心面板,形成分层、带斜面的质感。
- Button-in-button CTA:药丸按钮内部再嵌一个圆形图标芯片。
- Spring 动效:hover 态采用略微过冲的弹性缓动,带轻柔回弹。

设计细节:
- 银 / 奶色低对比度中性表面,仅用单一深鼠尾草绿强调色,贯穿品牌标记、圆点、环形与代码高亮。
- 顶部悬浮药丸导航,采用半透明模糊(磨砂)背景。
- Hero 区一侧是超大标题(含一段灰调的 .soft 续写),另一侧是双层斜面预览卡,内置一小块实时状态 bento。
- 双层斜面卡片组成 bento 网格,混排浅色卡与一张深色卡;hover 时卡片上浮并加深阴影。
- 内联 SVG 箭头字形与纯 CSS 环形 / 锥形渐变,让页面完全自包含(无外部图片 URL)。
- logo 跑马灯横向滚动、hover 时暂停;末尾用深色反转区块包裹收尾 CTA。
- 遵循 prefers-reduced-motion:禁用漂移、入场与脉冲动效。
...
<head>
  ...
  <title>NevoFlux — 更沉静的 AI 原生工作浏览器</title>
...
<body>
  ...
  <main>
    <section class="wrap hero reveal" data-od-id="hero">
      <div class="hero-copy">
        <span class="eyebrow"><span class="dot"></span>公开测试 · 2026 · Pack 12</span>
        <h1>为你的智能体,造一个更沉静的<span class="soft">工作浏览器。</span></h1>
        <p class="lede">NevoFlux 是一款 AI 原生浏览器,把你的 GBrain 知识库、Canvas 应用和内置智能体放进同一个窗口。不必再手动串联标签页、提示词和草稿文件 —— NevoFlux 让上下文、工具与产出始终同步。</p>
        <div class="actions">
          <button class="pill">
            <span>打开 NevoFlux</span>
            <span class="icon-wrap"><svg viewBox="0 0 12 12" stroke-width="1.6"><path d="M2.5 6h7M6 2.5L9.5 6 6 9.5"/></svg></span>
          </button>
          <button class="ghost">
            阅读 SDK 指南
        ...
        <div class="core">
          ...
          <div class="preview-grid">
            <div class="pv-cell span2">
              <div class="meta">agent · 在线</div>
              <div class="row" style="justify-content: space-between;">
                <div>
                  <h4 style="font-size: 14px;">canvas-agent / 研究</h4>
                  <div class="row" style="margin-top: 4px;"><span class="pulse"></span><p style="margin:0; font-size: 11px;">健康 · 已运行 7天14小时</p></div>
                </div>
                <div class="ring" aria-hidden="true"></div>
              </div>
            </div>
            <div class="pv-cell">
              <div class="meta">gbrain / 文档</div>
              <div class="num">2,418<small>条笔记</small></div>
            </div>
            <div class="pv-cell">
              <div class="meta">canvas 渲染 / 24h</div>
              <div class="num">1,284<small>成功</small></div>
            </div>
            <div class="pv-cell span2">
              <div class="meta">动态 · 最新一条</div>
              <p style="font-size: 11.5px; line-height: 1.6;">
                <code style="font-family: var(--mono); color: var(--accent);">04:12:09</code> · 画布 <code style="font-family: var(--mono);">DESIGN-PACK</code> 由 <b>canvas-agent/研究</b> 基于 <b>gbrain://product/specs</b> 渲染。耗时 41.7 秒。
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="block reveal" id="bento">
      <div class="wrap">
        <div class="section-head">
          <span class="eyebrow"><span class="dot"></span>02 · 平台</span>
          <p>五个核心能力。无框架锁定。自带你的模型、你的数据、你的 pack —— 把浏览器、知识库与智能体留在同一个窗口里。</p>
        </div>
        <div class="section-head" style="margin-bottom: 56px;">
          <h2>浏览器是无聊的那部分。而我们,<em style="font-weight:500; color: var(--muted); font-style: normal;">痴迷</em>于这无聊的部分。</h2>
          <span></span>
        </div>
        ...
        <div class="bento">
          <div class="b-card span-3 row-2">
            <div class="core">
              ...
              <h3>是知识库,不是一堆标签页。</h3>
              <p>GBrain 为每个工作区提供长期、可检索的记忆 —— 收纳你的文档、链接与笔记,并在 Canvas 应用与智能体会话间通用。智能体直接从中读取,而不必每次重新抓取网页。</p>
              <div class="codeblock">
                <span class="c">// 在 canvas 与 agent 间共享</span><br>
          ...
          <div class="b-card span-3">
            <div class="core">
              ...
              <h3>一块画布。一份上下文。一次渲染。</h3>
              <p>Canvas 应用基于你的 GBrain 上下文,即时构建页面与工具。在草稿过期变成复制粘贴的乱麻之前,NevoFlux 先把它重渲染好。</p>
              <div class="stat"><span class="big">0.41秒</span><span class="unit">平均 / 每次渲染</span></div>
            </div>
          </div>
          <div class="b-card span-3 dark">
            <div class="core">
              ...
              <h3>一个住在页面里的智能体。</h3>
              <p>长期运行。感知工具。读取你的 GBrain,驱动你的 Canvas 应用,并留下轨迹。每一步、每条提示词、每次工具调用、每处编辑 —— 都在一条你能回滚翻看的时间线上。</p>
            </div>
          </div>
          <div class="b-card span-2">
            <div class="core">
              <div class="meta">04 · 沙箱</div>
              <h3>真正的沙箱。</h3>
              <p>每个 Canvas 应用独享一个隔离微运行时。110 毫秒启动。</p>
            </div>
          </div>
          <div class="b-card span-2">
            <div class="core">
              ...
              <h3>可组合的 pack。</h3>
              <p>装入一个设计技能与模板的 pack。每晚更新。</p>
            </div>
          </div>
          <div class="b-card span-2">
            <div class="core">
              <div class="meta">06 · 工程体验</div>
              <h3>三套 SDK。两个 CLI。</h3>
              <p>Python、TypeScript、Go。<code style="font-family: var(--mono); color: var(--accent);">nevoflux</code> 与 <code style="font-family: var(--mono); color: var(--accent);">nf</code>。</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="marquee reveal">
      <div class="marquee-track">
        <span class="marquee-item">GBrain<em>·</em>Canvas<em>·</em>Agent SDK<em>·</em>Design Pack<em>·</em>技能<em>·</em>Packs<em>·</em>模板<em>·</em>种子<em>·</em>运行时<em>·</em>CLI<em>·</em></span>
        <span class="marquee-item" aria-hidden="true">GBrain<em>·</em>Canvas<em>·</em>Agent SDK<em>·</em>Design Pack<em>·</em>技能<em>·</em>Packs<em>·</em>模板<em>·</em>种子<em>·</em>运行时<em>·</em>CLI<em>·</em></span>
      </div>
    </section>

    <section class="closing reveal" data-od-id="closing">
      <div class="closing-inner">
        <h2>在你的上下文与产出之间,少一些胶带。</h2>
        <p>14 天试用,之后可选按量付费或按年付费。我们会派一位真正的工程师协助接入。没有销售漏斗。</p>
        <button class="pill">
          <span>联系工程师</span>
          <span class="icon-wrap"><svg viewBox="0 0 12 12" stroke-width="1.6"><path d="M2.5 6h7M6 2.5L9.5 6 6 9.5"/></svg></span>
        </button>
  ...
  <footer>
    <div class="row">
      <span>NevoFlux 浏览器 · SOC 2 · ISO 27001 · v2026.05</span>
      <span><a href="#">文档</a> · <a href="#">更新日志</a> · <a href="#">状态</a> · <a href="#">隐私</a> · <a href="#">联系我们</a></span>
    </div>
  </footer>
...
- `topnav` —— 药丸导航:品牌名、3-4 个区块链接,以及一个主 CTA 药丸按钮。
- `hero` —— 眼标(阶段 / 版本)、超大标题(含一段灰调的 `.soft` 续写)、一段 lede 引言、一个主药丸 CTA,以及一个 ghost 次级按钮。
- `hero-preview` —— 双层斜面预览卡,内含一小块实时 bento:状态格(智能体名 + 脉冲 + 环形)、两个指标格(`num` + `small` 单位),以及一行动态日志。
- `bento` —— 6 列网格上的六张双层斜面卡片;用 `.span-*` / `.row-2` 控制尺寸,给其中一张加 `.dark` 以制造对比。每张卡片含一个 `meta` 小标、一个 `h3`、正文,以及可选的 `stat`、`codeblock` 或内联 `code` 强调。
- `marquee` —— 把同一组条目重复两遍(第二份加 `aria-hidden`),让循环无缝衔接。
- `closing` —— 深色反转区块,含一个标题、一行支撑文案,以及单个 CTA 药丸。
- `footer` —— 左侧:产品 / 合规 / 版本字符串;右侧:一行内联链接。
- 所有指标、名称与标签保持自洽但仅作示意;视觉元素无需任何外部图片 / 字体资源。
