---
slug: packs/design-pack/templates/deck-xhs-pastel
type: template
lang: en
category: slides
title: "Pastel Slow-life Deck"
title_zh: "马卡龙慢生活 Deck"
description: "Cream-toned, soft-glow pastel slide deck for lifestyle, personal-growth, and emotional storytelling about NevoFlux."
tags: [xhs, pastel, lifestyle, template]
...
A soft, macaron slow-life deck. The intent is lifestyle, personal-growth, and emotion-forward content presented as a gentle, calming slideshow rather than a high-tech pitch.

### Layout
- Cream `#fef8f1` background with three soft-glow radial blobs (peach, lilac, mint) floating behind the content.
- Playfair Display italic serif for the display headings, paired with Inter / Noto Sans SC for body copy.
- 28px rounded "macaron" cards in six pastel fills: peach, mint, sky, lilac, lemon, rose.
- Playfair Display italic numerals (01-04) anchor each card.
- An SVG donut chart for the data slide, plus a top bar that pairs a status chip with the page indicator.

### Design details
- Keep the palette pastel and low-contrast; the ink color is a muted indigo `#2a2340`, never pure black.
- The hero headline can color individual words with the accent tints (peach, rose, mint) via `<em>` and `.rose` / `.mint` spans.
- Cards use a generous corner radius (28px) and a soft, wide drop shadow rather than hard borders.
- The chip dot color (peach / mint / sky / lilac / rose) signals the section, so vary it per slide.
- Keep everything self-contained: gradients and inline SVG only, no external images.
...
<title>NevoFlux Pastel Card</title>
...
<div class="deck">
  ...
  <section class="slide is-active">
    ...
    <div class="xp-kicker">Browsing With NevoFlux · 2026</div>
    <h1 class="xp-h1">Slow down,<br>let <em>NevoFlux</em><br>carry the <span class="rose">quiet</span><br>part of the web</h1>
    <div class="xp-divider"></div>
    <p class="xp-sub">This isn't a productivity manual. It's a short list of the browser chores you can hand to your NevoFlux agent — and get four calm hours back every week.</p>
    <div class="xp-footer"><span>by the NevoFlux team · pastel edition</span><span>cover</span></div>
  </section>
  ...
  <section class="slide">
    ...
    <div style="margin:auto 0">
      <div class="xp-kicker">Ask yourself first</div>
      <h1 class="xp-h1" style="font-size:120px">Which tabs<br>do you <span class="mint">never really want</span> to open?</h1>
      <p class="xp-sub">Not the ones you have to open — the ones where your attention quietly sighs every time.</p>
    </div>
  ...
  <section class="slide">
    <div class="xp-blob b1"></div>
    <div class="xp-topbar"><div class="xp-chip rose">Four little hand-offs</div><div class="xp-page">03 · 08</div></div>
    <h2 class="xp-h2">Four small jobs<br>to give the <em>NevoFlux</em> agent</h2>
    <div class="xp-grid-2">
      <div class="xp-card peach"><div class="xp-num">01</div><h4>Triage your inbox tabs</h4><p>The "got it, thanks" replies don't need you. Let the agent answer in your tone — about 40 minutes back each week.</p></div>
      <div class="xp-card mint"><div class="xp-num">02</div><h4>Book, rebook, compare</h4><p>One sentence and the agent drives ten sites for you. You only pick the final option, not juggle ten tabs.</p></div>
      <div class="xp-card sky"><div class="xp-num">03</div><h4>Turn pages into GBrain notes</h4><p>Clip a page, the agent summarizes it and files it into your GBrain knowledge base. You just confirm and tag.</p></div>
      <div class="xp-card lilac"><div class="xp-num">04</div><h4>Build a quick Canvas app</h4><p>Describe the little tool you wish existed; the SDK scaffolds a Canvas app from a design-pack skill. Reviewing it is the only manual step.</p></div>
    </div>
  ...
  <section class="slide">
    ...
    <div class="xp-hero-card">
      <p class="xp-quote">A browser's job isn't to help you<em> do more</em>,<br>it's to earn you the right to <em>do less</em>.</p>
      <div class="xp-divider"></div>
      <p class="xp-sub">Once your inbox tabs, bookings, page notes, and small tools all live with the NevoFlux agent, you notice the surprise — four hours of the week are suddenly empty.</p>
    </div>
  ...
  <section class="slide">
    ...
    <h2 class="xp-h2">The <em>inbox-triage</em><br>pack, in <span class="rose">one block</span></h2>
    <pre class="xp-codebox"><span class="cm"># nevoflux pack :: inbox-triage</span>
<span class="kw">when</span> tab matches <span class="st">"thanks / confirmed / received / noted"</span>:
  reply:
    tone: <span class="st">"warm, short, never corporate"</span>
    max_lines: <span class="hl">2</span>
    sign_with: <span class="st">"— sent via NevoFlux"</span>

<span class="kw">always_skip</span>:
  - from: [<span class="st">"family"</span>, <span class="st">"partner"</span>, <span class="st">"close friends"</span>]
  - contains: [<span class="st">"urgent"</span>, <span class="st">"contract"</span>, <span class="st">"payment"</span>]

<span class="cm"># saves 38 min/week — measured in GBrain</span></pre>
  ...
  <section class="slide">
    ...
    <h2 class="xp-h2">4 hours a week, <span class="mint">handed back</span></h2>
    <div style="display:flex;align-items:center;gap:60px;margin-top:30px">
      ...
      <div style="flex:1">
        <div class="xp-grid-2" style="grid-template-columns:1fr;gap:12px;margin-top:0">
          <div class="xp-card peach" style="padding:14px 20px;display:flex;align-items:center;gap:14px"><div style="width:14px;height:14px;border-radius:50%;background:var(--xp-peach-d)"></div><div><h4 style="margin:0;font-size:17px">48 min · inbox tabs</h4></div></div>
          <div class="xp-card mint" style="padding:14px 20px;display:flex;align-items:center;gap:14px"><div style="width:14px;height:14px;border-radius:50%;background:var(--xp-mint-d)"></div><div><h4 style="margin:0;font-size:17px">72 min · book / rebook / compare</h4></div></div>
          <div class="xp-card sky" style="padding:14px 20px;display:flex;align-items:center;gap:14px"><div style="width:14px;height:14px;border-radius:50%;background:var(--xp-sky-d)"></div><div><h4 style="margin:0;font-size:17px">56 min · GBrain notes</h4></div></div>
          <div class="xp-card lilac" style="padding:14px 20px;display:flex;align-items:center;gap:14px"><div style="width:14px;height:14px;border-radius:50%;background:var(--xp-lilac-d)"></div><div><h4 style="margin:0;font-size:17px">24 min · Canvas apps</h4></div></div>
        </div>
      </div>
    </div>
  ...
  <section class="slide">
    ...
    <h2 class="xp-h2">This weekend,<br>give yourself <em>a small break</em></h2>
    <div class="xp-grid-3">
      <div class="xp-card lemon"><div class="xp-num">☕</div><h4>Saturday morning</h4><p>Pick your most annoying chore, write one NevoFlux pack, and let it stop bothering you for good.</p></div>
      <div class="xp-card peach"><div class="xp-num">🌸</div><h4>Saturday afternoon</h4><p>Go for a walk. Take nothing. The agent watches your tabs and GBrain back home.</p></div>
      <div class="xp-card sky"><div class="xp-num">🌙</div><h4>Sunday night</h4><p>Review: which four hours were really empty? Keep going next week.</p></div>
    </div>
  ...
  <section class="slide">
    ...
    <div style="margin:auto 0;text-align:center">
      ...
      <h1 class="xp-h1" style="font-size:160px;text-align:center">thanks <em>·</em> NevoFlux</h1>
      <div class="xp-divider" style="margin:24px auto"></div>
      <p class="xp-sub" style="margin:0 auto">If you'd like a gentler week too, tell us in the comments which chore you'll hand to your agent first ♡</p>
    </div>
...
- Slide 1 (COVER): chip label, kicker (theme + year), big serif headline with one accented word, divider, lead sub-paragraph, and the byline / "cover" footer.
- Slide 2 (SECTION): chapter chip + a single oversized question headline (use `.mint` / `.rose` to color one phrase) and a one-line sub.
- Slide 3 (CONTENT 2x2): four pastel macaron cards, each with an italic numeral, an `<h4>` title, and a short paragraph. Rotate card colors (peach / mint / sky / lilac).
- Slide 4 (QUOTE): a hero card holding one `.xp-quote` pull quote plus a supporting sub-paragraph.
- Slide 5 (CODE / PROMPT): a dark `.xp-codebox` showing a short config / pack snippet; use `.cm` comments, `.kw` keywords, `.st` strings, and `.hl` highlights.
- Slide 6 (CHART): an SVG donut plus a stacked legend of labeled time rows; keep the dash-array segments and the legend in sync if you change the numbers.
- Slide 7 (CTA): three lemon / peach / sky cards using an emoji as the numeral, each a small weekend action.
- Slide 8 (THANKS): centered closing headline, divider, and a one-line invitation. Update the chip dot color and page counter (XX · 08) on each slide to match its section.
