---
slug: packs/design-pack/templates/deck-presenter-mode-zh
type: template
lang: zh
category: slides
title: "演讲者模式 Deck"
title_en: "Presenter Mode Deck"
description: "为怕忘词的演讲者准备的 deck,每页带逐字稿 notes 与 popup 提词器。"
tags: [presenter, notes, 提词, teleprompter, 模板]
...
为怕忘词的演讲者专用的 deck,每页都带逐字稿与 popup 提词器,让你随时知道下一句该说什么。

### 布局
- 每页结尾放一个 `<aside class="notes">`,写 150-300 字的逐字稿(对观众视图隐藏)。
- 右下角小 toolbar:按 `T` 切换主题,按 `S` 打开演讲者 popup。
- Popup 内含四张磁吸卡:CURRENT(当前页)/ NEXT(下一页预览)/ SCRIPT(逐字稿)/ TIMER(计时器)。

### 设计细节
- 默认 tokyo-night 主题;共 5 套主题(含一套 light):tokyo-night、dracula、catppuccin-mocha、nord、corporate-clean。
- 观众窗口保持普通 deck 视图;逐字稿通过 `.notes{display:none}` 隐藏,只在演讲者 popup 中显示。
- notes 用口语写、别写成书面语 —— 它是你瞄一眼的提示,不是要念出来的文章。
...
<title>演讲者模式 Deck · NevoFlux</title>
...
<div class="deck">
  ...
  <section class="slide" data-title="Cover">
    ...
    <h1 class="h1 anim-fade-up" data-anim="fade-up">如何做一场<br><span style="background:var(--grad);-webkit-background-clip:text;background-clip:text;color:transparent">不卡壳</span>的 NevoFlux 演示</h1>
    <p class="lede mt-m">按 <span class="mono">S</span> 进入演讲者视图 · <span class="mono">T</span> 切换主题 · <span class="mono">← →</span> 翻页</p>
    <div class="speaker">
      <div class="av"></div>
      <div><b>@samuel</b><span>产品演示 · 30 min</span></div>
    </div>
    ...
    <aside class="notes">
      <p>大家好,欢迎来到今天的 NevoFlux 演示。我是 Samuel,今天想跟大家聊一个很多产品演示都做不好的话题——<strong>如何把 NevoFlux 这样的产品当场演示得既有深度,又讲得不卡壳</strong>。</p>
      <p>正式开始前,先介绍一下这份 deck 本身:它是用 NevoFlux design-pack 做的、开了演讲者模式的 HTML 幻灯片。你们现在看到的是观众视图,但我自己的屏幕上是完全不一样的东西——当前页、下一页、完整逐字稿、计时器,全在一块屏幕上。</p>
      <p>为什么要专门做这个?因为我发现现场演示 NevoFlux 浏览器、GBrain 知识库和 Canvas 应用时,最大的痛点不是某一页讲不好,而是<strong>翻到下一页时突然忘了过渡怎么接</strong>。今天这份分享既是内容本身,也是个演示——我会一直开着演讲者模式讲。</p>
      <p>今天大概 30 分钟,分 5 个部分。有问题随时打断。Let's go。</p>
    </aside>
  </section>
  ...
  <section class="slide" data-title="Agenda">
    ...
    <div class="stack mt-l">
      <div class="agenda-row"><span class="num">01</span><span class="t">为什么 deck 做得漂亮还不够</span><span class="d">~5min</span></div>
      <div class="agenda-row"><span class="num">02</span><span class="t">演讲者视图到底该显示哪些信息</span><span class="d">~6min</span></div>
      <div class="agenda-row"><span class="num">03</span><span class="t">逐字稿怎么写才不像念稿</span><span class="d">~8min</span></div>
      <div class="agenda-row"><span class="num">04</span><span class="t">Live demo · NevoFlux design-pack deck 技能</span><span class="d">~8min</span></div>
      <div class="agenda-row"><span class="num">05</span><span class="t">Takeaways + Q&amp;A</span><span class="d">~3min</span></div>
    </div>
    <aside class="notes">
      <p>先过一下今天的议程。</p>
      <p>第一部分我想先说服你们<strong>"deck 做得漂亮≠演示得好"</strong>。我见过太多很精致的 NevoFlux 演示,但讲的人一现场打开 GBrain 就开始 "嗯…这个…就是…"。</p>
      <p>第二部分聊演讲者视图。业界的产品差别蛮大的,Keynote、PowerPoint、reveal.js 都有各自的方案,但当你要演示一个浏览器和它的 Canvas 应用时,真正好用的设计逻辑是什么,我会给出我的答案。</p>
      <p>第三部分是今天的<em>核心</em>——逐字稿。很多人以为逐字稿就是把要说的话一字不差写下来,错。逐字稿的目的是让你<strong>"看一眼就接得上"</strong>,写法完全不一样。</p>
      <p>第四部分会现场 demo 我自己用的 NevoFlux design-pack deck 技能,展示如何 30 分钟出一份带逐字稿的 deck。</p>
      <p>最后收尾 + 答疑。OK,进入第一部分。</p>
    </aside>
  </section>
  ...
  <section class="slide" data-title="Problem">
    ...
    <h2 class="h2">做 deck 和演示 deck,<br>是<span class="accent">两件事</span>。</h2>
    <div class="grid g3 mt-l">
      ...
      <div class="card card-accent">
        <h4>❌ 演示得好</h4>
        <p class="dim">逻辑连贯、语速稳定、不 "嗯啊"、能接住问题、能在 GBrain 加载时当场调整节奏。</p>
      </div>
      <div class="card card-accent">
        <h4>💡 差别在哪</h4>
    ...
    <aside class="notes">
      <p>我先抛一个可能有争议的观点——<strong>做 NevoFlux 的 deck 和现场演示它是两件完全不同的事</strong>。</p>
      <p>大家看左边这张卡片,"deck 做得好" 意味着什么?主题统一、排版干净、图表清晰、动效克制——这些都是<em>静态作品</em>的质量标准,可以离线评判。</p>
      <p>但中间这张卡片就不一样了:"演示得好" 意味着逻辑连贯、语速稳定、不卡壳、能接住提问,还能在一条 GBrain 查询或某个 Canvas 应用加载时根据现场反应调整节奏——这些是<strong>临场能力</strong>,跟 deck 好不好看基本没关系。</p>
      <p>最关键的是右边这句话——演示得好的人,本质上是"<strong>看一眼幻灯片就知道下句话说什么</strong>"。这个能力靠什么?不是背稿,也不是即兴发挥,而是靠<em>合理设计的提词器系统</em>。</p>
  ...
  <section class="slide" data-title="Presenter View">
    ...
    <div class="grid g2 mt-l">
      <div>
        ...
        <div class="feature-row"><span class="num green">②</span><div><b>下一页预览</b><p class="dim">帮你提前准备过渡句,避免"GBrain 那页之后我忘了讲什么了"。</p></div></div>
      </div>
      <div>
    ...
    <aside class="notes">
      ...
      <p>第一块,<strong>当前页大图</strong>。这个必须占据视图一半以上空间,因为它是你跟观众的"同步锚"——观众在 NevoFlux Canvas 上看到什么,你脑子里也得是什么。</p>
      <p>第二块,<strong>下一页预览</strong>。这个很多人不理解为什么要放,我解释一下:演示最卡的瞬间不是讲某一页,而是<em>翻到下一页的那 2 秒</em>。如果你提前看到下一页长什么样,过渡句自然就有了。</p>
    ...
    <div class="stack mt-l">
      <div class="rule-row">
        ...
        <div>
          ...
          <p class="dim">把要讲的核心点加粗,把过渡句单独成段,把数据和 GBrain、Canvas 这类名字列清楚——<em>让你看一眼就接得上</em>。</p>
        </div>
      </div>
      <div class="rule-row">
      ...
      <div class="rule-row">
        ...
        <div>
          ...
          <p class="dim">"因此" → "所以";"该功能" → "这个功能"。写的时候读一遍,听起来像说话才对。</p>
        </div>
      </div>
    </div>
    <aside class="notes">
      ...
      <p>逐字稿的真实作用是<em>"提示信号"</em>——把核心要点加粗,把过渡句单独成段,把数据和 GBrain、Canvas 这些专有名词列清楚。这样你讲的时候<strong>瞄一眼就能接得上</strong>,但说出来的还是你自己的话。</p>
      <p><strong>第二条,每页控制在 150 到 300 字</strong>。这个是我做了十几场演示摸出来的经验值。少于 150 字提示不够,讲到一半卡住;多于 300 字你根本来不及扫完。按一页讲 2 到 3 分钟算,这个字数刚好。</p>
      <p><strong>第三条,用口语写</strong>。这条最多人栽跟头。你写"因此",讲出来会变成"所以";你写"该功能",讲出来会变成"这个功能"。<em>写的时候读一遍</em>,不拗口才对。</p>
      <p>这三条配合起来,你会发现演示 NevoFlux 突然变成了一件很舒服的事。</p>
    </aside>
  </section>
...
<span class="comment"># 添加 NevoFlux design-pack</span>
<span class="cmd">nevo</span> pack add <span class="flag">design-pack</span>

<span class="comment"># 用演讲者模式模板新建 deck</span>
...
<span class="flag">R</span>  <span class="comment">→ 重置计时器</span>
    ...
    <aside class="notes">
      <p>最后我演示一下这个技能怎么用,给大家省点时间自己摸索。</p>
      <p>第一步,添加 NevoFlux design-pack,一行命令。第二步,用 <code>presenter-mode</code> 模板在你自己的项目里新建一份 deck。第三步,打开 html,按 S。</p>
      <p>键盘操作我列在这里了。<strong>S 进入演讲者视图、T 切换主题、左右键翻页、R 重置计时器</strong>。主题默认带 5 个——tokyo-night、dracula、catppuccin-mocha、nord、corporate-clean——基本覆盖了深色技术演示、浅色商务汇报两种常见场景。</p>
      <p>最关键的一步——<em>每一页底部的 <code>&lt;aside class="notes"&gt;</code> 里,老老实实写 150 到 300 字的逐字稿</em>。这是整个方法论的交付物。NevoFlux 的 agent 可以帮你写初稿,但你一定要自己过一遍,读出来听听是不是你会说的话。</p>
      <p>好,我今天就讲到这里。如果你做下一场演示的时候想起了这个"演讲者视图 + 逐字稿"的组合,并且觉得讲得比以前顺——那就是我最大的收获。谢谢大家,有问题现在开始。</p>
    </aside>
  </section>
...
- 封面页:设置演讲标题、渐变高亮词、演讲者 handle(`.speaker b`)与副标题,以及页脚 hashtags。
- 议程页:每个 `.agenda-row` 填入编号、主题和大致时长。
- 问题页:三张 `.card-accent` 卡片,对比"做 deck"与"演示 deck"的差距。
- 演讲者视图页:四个 `.feature-row` 面板(当前页 / 下一页 / 逐字稿 / 计时器)。
- 逐字稿页:三条 `.rule-row` 铁律,讲怎么写 notes。
- 演示与收尾页:`.code-block` 安装/键盘参考,加收尾 lede。
- 每一页结尾都放一个 `<aside class="notes">`,写 150–300 字逐字稿 —— 对观众隐藏,在演讲者 popup 中显示(按 `S`)。按 `T` 循环切换 5 套主题。
