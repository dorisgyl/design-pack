---
slug: packs/design-pack/templates/deck-xhs-post
type: template
lang: en
category: slides
title: "Xiaohongshu Post Deck (NevoFlux)"
title_zh: "小红书图文 Deck"
description: "A 9-page 3:4 vertical Xiaohongshu / Instagram carousel with warm pastel backgrounds and dashed sticker cards."
tags: [xhs, instagram, carousel, template]
sample_image: packs/design-pack/assets/templates/deck-xhs-post.svg
source: html-anything/deck-xhs-post
---

## Design guidance

Template: Xiaohongshu / Instagram Carousel

Intent: a 9-page 3:4 vertical post for publishing to Xiaohongshu or as an Instagram carousel.

Layout
- Cover + N content pages + a closing CTA. Let N follow the content: cover every point completely. Short content starts around 7 pages; longer content should run more. Because a single Xiaohongshu post caps the number of images, keep the total at or below 18.
- Warm pastel background.
- Dashed "sticker" cards plus page-number dots at the bottom.

Design details
- Each slide is a fixed 810x1080 (3:4) card with rounded corners and a soft radial-gradient glow in the corners.
- Headlines are heavy and oversized; body copy uses wide line spacing so it stays readable on a phone.
- Decorate with hand-drawn sticker badges (pink / yellow / blue / green), numbered step circles, and bordered "hand-box" cards that carry a hard offset shadow for a doodle feel.
- Keep one core idea per page; lead with an emoji and a short, punchy line.
...
<title>Drowning in tabs? Let NevoFlux read them for you · Xiaohongshu Post</title>
...
<div class="deck">
  ...
  <section class="slide" data-title="Cover">
    ...
    <div class="sticker pink" style="top:120px;left:48px;transform:rotate(-6deg)">😮‍💨 tab chaos</div>
    <div class="sticker yellow" style="top:140px;right:64px;transform:rotate(5deg)">tried it 7 days</div>
    <div style="margin-top:200px">
      <p class="lede" style="font-size:24px;color:var(--text-1);font-weight:600">A survival guide for tab hoarders</p>
      <h1 class="h1 mt-s">Stop drowning in <span class="cover-title">100 tabs</span><br>let <span class="cover-title">NevoFlux</span><br>read them for you</h1>
    </div>
    <div class="bottom-bar"><div><span class="avatar">N</span> <b style="color:var(--text-1);margin-left:8px">@nevoflux.daily</b></div><div>← swipe to see how</div></div>
  </section>
  ...
  <section class="slide" data-title="Hook">
    ...
    <h2 class="h2 tc mt-l">Wait, don't swipe away!</h2>
    <p class="lede tc mt-m" style="padding:0 20px">I used to keep<br>80 tabs open "just in case",<br><br>until I let<br><b style="color:var(--accent)">one tool</b> remember them for me.</p>
    <div class="sticker blue" style="bottom:160px;left:50%;transform:translateX(-50%) rotate(-2deg)">the real turning point ↓</div>
  </section>

  <!-- 3. Pain -->
  <section class="slide" data-title="Pain">
    <div class="page-dot">3 / 9</div>
    <p class="lede" style="font-weight:700;color:var(--accent)">❌ Sound familiar?</p>
    <h2 class="h2 mt-s">More tabs, less focus</h2>
    <div class="stack mt-l">
      <div class="hand-box"><b style="font-size:22px">🔖 47 "read later" bookmarks</b><p class="dim" style="font-size:16px;margin-top:4px">never opened again, ever</p></div>
      <div class="hand-box"><b style="font-size:22px">🔍 Ctrl+F across 12 sites</b><p class="dim" style="font-size:16px;margin-top:4px">you know you saw it somewhere</p></div>
      <div class="hand-box"><b style="font-size:22px">📋 copy-pasting into a doc</b><p class="dim" style="font-size:16px;margin-top:4px">the links rot by next week</p></div>
    </div>
  </section>
  ...
  <section class="slide" data-title="Aha">
    ...
    <p class="lede mt-l" style="color:var(--accent);font-weight:700">💡 The truth is</p>
    <h2 class="h2 mt-s">You don't have a memory problem,<br>your <span style="background:var(--accent-3);padding:0 8px">browser does</span>.</h2>
    <p class="lede mt-l">NevoFlux saves every page you read<br>into GBrain, its built-in knowledge base.<br>Then you just ask, in plain words.</p>
    <p class="lede mt-m" style="color:var(--text-1);font-weight:700">The key: <span style="color:var(--accent)">read once, recall anytime</span>.</p>
  </section>
  ...
  <section class="slide" data-title="Step 1">
    ...
    <h2 class="h2 mt-m">Browse like normal</h2>
    <div class="hand-box mt-l">
      <p style="font-size:22px;margin:0;color:var(--text-1);font-weight:700">👉 Zero extra effort</p>
      <p style="font-size:20px;margin:10px 0 0;color:var(--text-2);line-height:1.7">Open pages in the <b style="color:var(--accent)">NevoFlux browser</b><br>and GBrain quietly indexes each one</p>
    </div>
    <div class="hand-box mt-m" style="background:#fff5ef">
      <p style="font-size:18px;margin:0;color:var(--text-2)">For example: read 30 reviews</p>
      <p style="font-size:24px;margin:8px 0 0;color:var(--text-1);font-weight:800">→ all 30 land in GBrain<br>→ searchable in one place</p>
    </div>
  </section>
  ...
  <section class="slide" data-title="Step 2">
    ...
    <h2 class="h2 mt-m">Just ask the agent</h2>
    <div class="hand-box mt-l">
      <p style="font-size:22px;margin:0;color:var(--text-1);font-weight:700">💬 "Which laptop had the best battery?"</p>
      <p style="font-size:18px;margin:8px 0 0;color:var(--text-2);line-height:1.6">The NevoFlux agent reads your saved pages and answers with sources, no re-googling. Works even when those tabs are long gone.</p>
    </div>
    <div class="sticker yellow" style="bottom:200px;right:60px;transform:rotate(8deg)">⚡ faster than search</div>
    <div class="hand-box mt-m" style="background:#fff5ef">
      <p style="font-size:18px;margin:0;color:var(--text-2)">Lazy mode:</p>
      <p style="font-size:22px;margin:6px 0 0;color:var(--text-1);font-weight:700">type a question, hit enter 💬</p>
    </div>
  </section>
  ...
  <section class="slide" data-title="Step 3">
    ...
    <h2 class="h2 mt-m">Turn it into<br>a Canvas app</h2>
    <div class="hand-box mt-l">
      <p style="font-size:20px;margin:0;color:var(--text-2);line-height:1.6"><b style="color:var(--text-1)">🎨 One prompt.</b> Ask for a comparison table and NevoFlux builds a live Canvas app from your GBrain notes.</p>
    </div>
    <div class="hand-box mt-m" style="background:#fff5ef">
      <p style="font-size:20px;margin:0;color:var(--text-2);line-height:1.6"><b style="color:var(--text-1)">💡 Pro tip:</b> save the Canvas app as a pack and reuse it next time, your research becomes a reusable tool.</p>
    </div>
    <div class="sticker pink" style="bottom:140px;left:50%;transform:translateX(-50%) rotate(-3deg)">power-user cheat code</div>
  </section>

  <!-- 8. Result -->
  <section class="slide" data-title="Result">
    <div class="page-dot">8 / 9</div>
    <p class="lede" style="color:var(--good);font-weight:700">✅ After 7 days with NevoFlux</p>
    <h2 class="h2 mt-s">Here's what changed…</h2>
    <div class="stack mt-l">
      <div class="hand-box"><b style="font-size:22px">😌 Down from 80 tabs to 6</b></div>
      <div class="hand-box"><b style="font-size:22px">💪 Found answers in seconds</b></div>
      <div class="hand-box"><b style="font-size:22px">🔖 Stopped hoarding bookmarks</b></div>
      <div class="hand-box" style="background:var(--accent-3);border-color:var(--text-1)"><b style="font-size:24px">✨ Best part: research that lasts</b></div>
    </div>
  </section>
  ...
  <section class="slide" data-title="CTA">
    ...
    <h2 class="h2 tc mt-l">If this was useful</h2>
    <h1 class="h1 tc mt-s" style="color:var(--accent)">save + follow 🧡</h1>
    <p class="lede tc mt-l" style="padding:0 30px">Next up:<br><b style="color:var(--text-1)">"5 NevoFlux packs that save you an hour a day"</b><br>build them once, run them forever</p>
    <div class="tag-row" style="justify-content:center;margin-top:36px">
      <span class="ht">#NevoFlux</span>
      <span class="ht">#GBrain</span>
      <span class="ht">#AIbrowser</span>
      <span class="ht">#productivity</span>
    </div>
    <div class="bottom-bar"><div><span class="avatar">N</span> <b style="color:var(--text-1);margin-left:8px">@nevoflux.daily</b></div><div>❤️ 52k</div></div>
  </section>
...
- Slide 1 (Cover): oversized hook headline with the product name; two tilted sticker badges, author handle in the bottom bar.
- Slide 2 (Hook): a stop-scrolling line plus a short personal story that promises one big payoff.
- Slide 3 (Pain): the "sound familiar?" list of relatable problems, one `hand-box` per pain point.
- Slide 4 (Aha): the reframe / insight, with one phrase highlighted on the accent background.
- Slides 5-7 (Steps): numbered `num-circle` + a method per page; pair a `hand-box` formula/explanation with an example box. Recolor each step's circle via `--accent`, `--accent-2`, `--accent-3`.
- Slide 8 (Result): proof points after trying it, the last `hand-box` highlighted as the punchline.
- Slide 9 (CTA): emoji + save/follow ask, a teaser for the next post, and hashtag chips in `.tag-row`.
- Update `.page-dot` (`n / total`) and the closing like count to match your real page count and metrics. Add or remove content slides between Cover and CTA to fit your topic (keep the total at or below 18).
